...
const wifi6eCybersecurityGatewayImages =
  embeddedCaseStudiesData.find((study) => study.id === "wifi-6e-router")?.images ?? [];
...
export const wifi6eCybersecurityGatewayCaseStudy: FullProductDevelopmentCaseStudy = {
  ...
  challenges: [
  {
    ...
    "resolution": "Packing three 4×4 MU-MIMO antenna sets (12 antennas total) inside a compact, antenna-less enclosure required custom antenna layout engineering and RF isolation techniques to prevent inter-band interference while maintaining rated throughput on all three bands"
  },
  {
    "challenge": "Simultaneous tri-band WiFi 6E throughput",
    "resolution": "Achieving maximum 802.11ax throughput on 2.4 GHz, 5.1 GHz, and 5.8 GHz simultaneously under real-world multi-user loads demanded careful radio coexistence tuning and OpenWRT scheduler optimisation"
  },
  {
    "challenge": "SI/PI/EMI on a dense BGA PCB",
    "resolution": "Routing DDR4 (high-speed memory), PCIe Gen 2, Gigabit Ethernet RGMII, and three RF radio interfaces on a compact 6-layer PCB required meticulous impedance control, layer stack-up planning, and SI/PI analysis"
  },
  {
    "challenge": "Fanless thermal management in plastic enclosure",
    "resolution": "The MT7986AV under full WiFi load and security processing generates significant heat; the enclosure and PCB were engineered with thermal via arrays and airflow paths to sustain continuous operation without active cooling"
  },
  {
    "challenge": "Concurrent security processing without throughput degradation",
    "resolution": "Running DNS blocking, IP/domain reputation filtering, AI-powered threat detection, and firewall rules simultaneously with high-throughput WiFi routing required hardware NAT offload, kernel flow offload, and multi-core packet-processing tuning"
  },
  {
    "challenge": "Onboard threat-intelligence database management",
    "resolution": "Storing, updating, and hot-reloading large blocklists (IPs, domains, URLs) within cost-optimised 32 GB eMMC without service interruption required atomic staging and reload mechanisms in firmware"
  },
  {
    "challenge": "Dual-platform mobile app with shared backend",
    "resolution": "Developing and maintaining feature-parity Android and iOS apps, each meeting their respective platform review requirements, while sharing a common REST API backend"
  },
  {
    "challenge": "Cryptographically signed OTA at scale",
    "resolution": "Implementing a reliable, RSA-signed OTA update mechanism for firmware and security-policy updates across thousands of deployed field units, with staged rollout and automatic rollback on failure"
  },
  {
    "challenge": "FCC Part 15B first-submission pass — tri-band device",
    "resolution": "Achieving FCC certification on the first submission for a device with 12 internal antennas across three simultaneous RF bands required precise antenna placement, controlled impedance routing, and careful EMC management"
  },
  {
    "challenge": "Mass manufacturing and cross-border logistics",
    "resolution": "Producing thousands of units on schedule including custom packaging, UL-certified power adapters, and cross-border fulfilment to North America within cost and time targets"
  }
],
  hardwareComponents: [
  {
    "title": "MediaTek MT7986AV",
    "description": "Quad-core ARM Cortex-A53 main SoC with integrated Network Processing Unit (NPU), hardware NAT offload, and the processing headroom to run the full cybersecurity stack concurrently with multi-band WiFi routing"
  },
  {
    "title": "MediaTek MT7531AE",
    "description": "5-port Gigabit Ethernet switch providing WAN and LAN ports via RGMII interface to the main SoC"
  },
  {
    "title": "MediaTek MT7976AN",
    "description": "WiFi 6E 5.1 GHz band 4×4 MU-MIMO radio chip connected via PCIe"
  },
  {
    "title": "MediaTek MT7915AN",
    "description": "WiFi 6 5.8 GHz band 4×4 MU-MIMO radio chip connected via PCIe"
  },
  {
    "title": "MediaTek MT7976GN",
    "description": "WiFi 6 2.4 GHz band 4×4 MU-MIMO radio chip connected via PCIe"
  },
  {
    "title": "4 GB DDR4 DRAM",
    "description": "High-speed system memory providing the bandwidth required for simultaneous WiFi packet processing, threat-intelligence lookups, and OpenWRT workloads"
  },
  {
    "title": "32 GB eMMC Flash",
    "description": "Embedded storage (HS400 mode) for OS, firmware, blocklists, security logs, and OTA staging with A/B partition support"
  },
  {
    "title": "USB 3.0 Controller",
    "description": "SuperSpeed host port for external storage or diagnostic interface"
  },
  {
    "title": "12-Element Internal Antenna Array",
    "description": "Custom-designed tri-band antenna set for 4×4 MU-MIMO on all three bands, fully enclosed inside the sealed plastic enclosure with no external protrusions"
  },
  {
    "title": "UL-Certified 12 V DC Power Supply",
    "description": "UL-listed power adapter selected and qualified for US/North American market compliance and bundled with every unit"
  }
],
  interfaces: [
  {
    "title": "Gigabit Ethernet (WAN + LAN)",
    "description": "Via RGMII interface to MT7531AE 5-port Gigabit switch; supports 10/100/1000 Mbps on all ports"
  },
  {
    "title": "Wi-Fi 6E 802.11ax — Triband",
    "description": "Simultaneous 4×4 MU-MIMO on 2.4 GHz, 5.1 GHz, and 5.8 GHz; OFDMA; BSS Colouring; WPA3; Target Wake Time (TWT)"
  },
  {
    "title": "PCIe Gen 2",
    "description": "Internal interconnect between the MT7986AV SoC and the three WiFi radio modules"
  },
  {
    "title": "DDR4",
    "description": "High-speed 64-bit wide memory interface between MT7986AV and system RAM"
  },
  {
    "title": "eMMC (HS400)",
    "description": "Embedded storage interface between SoC and onboard flash for OS and data"
  },
  {
    "title": "USB 3.0",
    "description": "SuperSpeed host port for external storage attachment or diagnostic console"
  },
  {
    "title": "SPI",
  ...
  {
    "title": "I2C",
    "description": "Power management IC (PMIC) control and peripheral sensor communication"
  },
  {
    "title": "UART",
    "description": "Serial debug console for firmware development, bring-up, and factory test"
  },
  {
    "title": "DC Power Jack",
    "description": "12 V DC input; UL-certified power adapter supplied for the US market"
  }
],
  firmwareItems: [
  {
    "title": "OpenWRT BSP & Platform Bring-up",
    "description": "U-Boot bootloader ported to MT7986AV; Linux kernel configured and brought up with custom device tree covering PCIe (WiFi radios), RGMII (Ethernet switch), USB 3.0, eMMC, SPI, I2C, UART, and GPIO. PMIC sequencing validated."
  },
  {
    "title": "WiFi Driver Integration & RF Calibration",
    "description": "WiFi drivers integrated for all three bands (MT7976AN, MT7915AN, MT7976GN); per-band RF calibration performed to achieve rated 802.11ax throughput; radio coexistence tuned for simultaneous tri-band operation under full load. FCC Part 15B passed on first regulatory submission."
  },
  {
    "title": "OpenWRT Performance & Throughput Optimisation",
    "description": "Hardware NAT offload and kernel flow offload enabled; multi-core packet-processing affinity tuned on MT7986AV to sustain maximum WiFi throughput under high concurrent-user loads while running the full security stack — with no measurable latency increase."
  },
  {
    "title": "Security Stack — Multi-Layer Threat Detection",
    "description": "AI-powered cloud threat intelligence integrated with on-device enforcement across multiple protection layers: DNS-level phishing and malware blocking, IP/domain/URL reputation filtering, network attack prevention (DDoS/brute-force), IoT device traffic monitoring, identity theft detection, and scam detection — all without packet payload inspection."
  },
  {
    "title": "DNS Security, URL Filtering & Firewall Engine",
    "description": "On-device DNS resolver integrated with continuously updated cloud blocklists; malicious domain queries blocked at resolution time before any connection is established. Domain and IP reputation-based URL blocking enforced at network level. Stateful firewall rules engine with zone-based policy management, connection tracking, and geo-IP blocking."
  },
  {
    "title": "Threat-Intelligence Database & Secure OTA",
    "description": "Automated pull, cryptographic verification, staging, and atomic hot-reload of IP/domain/URL blocklists to eMMC without service interruption. RSA-signed OTA update engine for firmware and security-policy packages with staged rollout, delta update support, and automatic rollback on failure."
  },
  {
    "title": "Factory Test Firmware",
    "description": "Automated production-line self-test application written to validate all interfaces: all Ethernet ports, WiFi RF on all three bands, USB enumeration, eMMC read/write, power-rail verification, LED, and button GPIO. Custom test fixture built for rapid in-line testing during manufacture."
  },
  {
    "title": "Android Application — Security Dashboard & Controls",
    "description": "Native Android app (Kotlin): guided QR-code/mDNS device setup, real-time threat and device dashboard, FCM push notifications for threat alerts and OTA events, parental controls with per-device scheduling, remote firewall rule management, biometric login, and in-app network speed test."
  },
  {
    "title": "iOS Application — Native App with Feature Parity",
    "description": "Native iOS app (Swift/SwiftUI) with full Android feature parity: guided setup, encrypted REST API dashboard sync, APNs push notifications, iOS Screen Time integration for parental controls, Touch ID/Face ID authentication, and pre-built security policy templates. Passed Apple App Store review on first submission."
  },
  {
    "title": "Cloud Management Dashboard & Fleet OTA",
    "description": "Web-based portal for IT administrators and MSPs: centralised OTA update scheduling and tracking across the fleet, aggregated threat analytics with trend reporting, per-unit device health monitoring, multi-tenant user and role management (SSO-ready), and REST API for webhook alerting and future SIEM/SOC integrations."
  }
],
  specs: [
  {
    "key": "SoC",
    "value": "MediaTek MT7986AV — Quad-core ARM Cortex-A53 with integrated Network Processing Unit (NPU) and hardware NAT offload"
  },
  {
    "key": "WiFi Radios",
    "value": "MT7976AN (5.1 GHz, 4×4), MT7915AN (5.8 GHz, 4×4), MT7976GN (2.4 GHz, 4×4) — 12-element internal antenna array"
  },
  {
    "key": "WiFi Standard",
  ...
  {
    "key": "PCB",
    "value": "6-Layer, impedance-controlled; controlled impedance routing for RF and high-speed interfaces"
  },
  {
    "key": "Ethernet",
    "value": "Gigabit WAN + LAN via MT7531AE 5-port switch (RGMII); 10/100/1000 Mbps"
  },
  {
    "key": "Interfaces",
  ...
  {
    "key": "Firmware / OS",
    "value": "OpenWRT (custom BSP on MT7986AV) with AI-powered multi-layer cybersecurity stack"
  },
  {
    "key": "Mobile Apps",
    "value": "Android (Kotlin), iOS (Swift/SwiftUI) — device setup, real-time security dashboard, parental controls, OTA management"
  },
  {
    "key": "Cloud Platform",
    "value": "Web-based fleet management dashboard; centralised OTA; threat analytics; multi-tenant; REST API"
  },
  {
    "key": "Enclosure",
    "value": "Custom plastic enclosure; compact form factor; no external antennas; 12-antenna internal array"
  },
  {
    "key": "Certifications",
    "value": "FCC Part 15B (first-submission pass); RoHS compliant; UL-certified power adapter (US market)"
  },
  {
    "key": "Power",
    "value": "12 V DC; UL-certified power adapter supplied for North American market"
  }
],
  summary: [
  ...
  listingSummary: "Full product development from concept to volume production — WiFi 6E tri-band cybersecurity gateway for North American SME deployment.",
  metadata: {
  "title": "WiFi 6E Triband Cybersecurity Gateway | Case Study",
  "description": "Full product development case study — WiFi 6E tri-band cybersecurity gateway with OpenWRT firmware, mobile apps, and cloud management."
},
};
