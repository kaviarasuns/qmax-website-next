...
export const mechanicalCaseStudiesData: CaseStudy[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Ergonomic industrial product design",
      "Efficient heat management structure",
      "User-friendly control interface layout",
      "Robust bench-top mechanical construction",
    ],
    summary:
      "A digitally controlled dry bath system designed for reliable laboratory heating applications with compact construction and efficient thermal management.",
    importantParts: [
      "Heating block enclosure",
      "Thermal insulation assembly",
      "Control interface housing",
      "Ventilation structure",
      "Internal mounting framework",
      "Protective outer casing",
    ],
    salientFeatures: [
      "Compact laboratory-friendly design",
      "Efficient thermal enclosure structure",
      "Reliable bench-top operation",
      "Clean and ergonomic product architecture",
    ],
    scopeOfWork: [
      "Mechanical Product Design",
      "Industrial CAD Modeling",
  ...
  },
  {
    ...
    features: [
      ...
      "Secure mechanical latch integration",
      "Embedded access control compatibility",
      "Ergonomic user interaction design",
      "Durable structural construction",
    ],
    summary:
      "A modern digital lock system designed for secure access control, compact embedded integration, and reliable everyday operation.",
    importantParts: [
      ...
      "Connector and wiring channels",
    ],
    salientFeatures: [
      "Secure and reliable locking mechanism",
      "Compact smart-device integration",
      "Durable industrial-grade construction",
      "User-friendly ergonomic design",
    ],
    scopeOfWork: [
      "Mechanical Product Design",
      "Industrial CAD Development",
  ...
  },
  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/TRNDX_SERVER/TRNDX_SERVER_ASSM_RENDER_S2.93.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/TRNDX_SERVER/TRNDX_SERVER_ASSM_RENDER_S2.95.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/TRNDX_SERVER/TRNDX_SERVER_ASSM_RENDER_S2.96.png",
    ...
    features: [
      "Industrial server enclosure design",
      "High-density hardware integration",
      "Optimized airflow and thermal architecture",
      "Rack-compatible structural assembly",
      "Modular maintenance-friendly layout",
      "Robust industrial-grade construction",
    ],
    summary:
      "TRNDX Server is a mechanically engineered server platform designed for high-density hardware integration, efficient thermal management, and reliable industrial deployment.",
    importantParts: [
      "Server chassis assembly",
      "Cooling and airflow channels",
      "Rack mounting structure",
      "Internal hardware support frame",
      "Cable management sections",
      "Protective outer enclosure",
    ],
    salientFeatures: [
      "Optimized thermal airflow management",
      "High-density rack-ready architecture",
      "Modular and service-friendly design",
      "Industrial-grade structural reliability",
    ],
    scopeOfWork: [
      "Mechanical System Design",
      "Industrial CAD Modeling",
...

  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/2.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/3.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/4.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/5.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/6.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/7.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/pdu_data_center/8.png",
    ],
    rotatedImages: {},
    features: [
...

  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V2/PDU3_VAR2_2.png",
    ],
    rotatedImages: {},
    features: [
      "Rack-mounted PDU mechanical enclosure",
...

  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V3/PDU3_VAR3_2.png",
    ],
    rotatedImages: {},
    features: [
      "Rack-mounted PDU mechanical enclosure",
...

  {
    ...
    category: "Mechanical Design",
    images: [
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V4/3.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V4/PDU3_VAR_4_C13__1.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V4/PDU3_VAR_4_C13__2.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V4/PDU3_VAR4_C13_C19_1.png",
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V4/PDU3_VAR4_C13_C19_2.png",
    ],
    rotatedImages: {},
    features: [
      "Rack-mounted PDU mechanical enclosure",
...

  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V5/PDU3_VAR5_C13_C19_2.png",
    ],
    rotatedImages: {},
    features: [
      "Rack-mounted PDU mechanical enclosure",
...

  {
    ...
    images: [
      ...
      "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/PDU/V6/PDU3_VAR6_C13_C19_2.png",
    ],
    rotatedImages: {},
    features: [
      "Rack-mounted PDU mechanical enclosure",
