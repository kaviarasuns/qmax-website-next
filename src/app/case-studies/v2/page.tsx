...
function SectionHead({ num, title }: { num: string; title: string }) {
  return (
    <div className="flex items-baseline gap-[0.9rem] mb-[1.2rem]">
      <span className={`${MONO} text-[0.74rem] text-[#5e97d5] font-medium tracking-[0.06em]`}>
        {num}
      </span>
      <h2 className="text-[clamp(1.5rem,3vw,2.1rem)] text-[#1c2a3a] font-light tracking-[0.03em] leading-[1.15] m-0">
        {title}
      </h2>
...
export default function CaseStudyV2Page() {
  ...
  return (
    <div className="bg-[#f5f7fa] text-[#1c2a3a] leading-[1.6] tracking-[0.015em] antialiased">
      <div className="fixed top-16 left-0 right-0 h-11 z-40 flex items-center justify-center px-[1.4rem] bg-[rgba(28,42,58,0.96)] backdrop-blur-[10px] border-b border-[#04243d]">
        <div
          className={`${MONO} text-[0.68rem] max-[760px]:text-[0.6rem] tracking-[0.16em] text-[#9bc0e9] uppercase text-center`}
        >
          Case Study · Rugged Android Digital Signage Player
        </div>
        <div
          className="absolute left-0 -bottom-px h-0.5 bg-red-500 transition-[width] duration-100 ease-linear motion-reduce:transition-none"
          style={{ width: `${progress}%` }}
        />
      </div>

      <header className="relative bg-[#f5f7fa] text-[#1c2a3a] overflow-hidden pt-[8.75rem] px-6 pb-[3.4rem]">
        <div className="relative max-w-[1200px] mx-auto grid grid-cols-[0.82fr_1.18fr] gap-[2.8rem] items-stretch max-[920px]:grid-cols-1 max-[920px]:gap-8 max-[920px]:items-start">
          <div className="min-w-0 flex flex-col">
            <div className={`${MONO} text-[0.72rem] tracking-[0.34em] uppercase text-red-500 font-medium`}>
              CASE STUDY
            </div>
            <h1 className="text-[clamp(1.8rem,3.6vw,2.9rem)] text-[#1c2a3a] my-[0.6rem] font-medium tracking-[0.005em] leading-[1.1]">
              Rugged Android Digital Signage Player
            </h1>
            <div className="text-[#5a6778] text-[clamp(1rem,1.8vw,1.2rem)] font-light max-w-[46ch]">
              Full Product Development — Concept to Volume Production
            </div>
            <div
              className={`${MONO} text-[0.76rem] tracking-[0.12em] text-[#5a6778] mt-[1.3rem] flex flex-wrap gap-y-[0.4rem] gap-x-[1.1rem]`}
            >
              {META_TAGS.map((tag) => (
                <span
                  key={tag}
            ...
            <div
              ...
              className={`relative grid grid-cols-2 border border-[#063458] rounded-lg overflow-hidden bg-[#04243d] mt-auto max-[920px]:mt-[1.4rem] transition-[opacity,transform] duration-700 ease-[ease] motion-reduce:transition-none motion-reduce:opacity-100 motion-reduce:translate-y-0 ${
                ribbonLit ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
            >
                ...
                return (
                  <div
                    ...
                    className={`relative overflow-hidden py-[1.1rem] px-[1.2rem] border-[#063458] ${
                      hasRight ? "border-r" : ""
                    } ${hasBottom ? "border-b" : ""} after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5 after:bg-red-500 after:origin-left after:transition-transform after:duration-[600ms] after:ease-[ease] motion-reduce:after:transition-none ${
                      ribbonLit ? "after:scale-x-100" : "after:scale-x-0"
                    }`}
                  >
                    <div className="text-[1.3rem] text-white font-normal">
                      {stat.value}
                    </div>
                    <div className={`${MONO} text-[0.64rem] tracking-[0.14em] uppercase text-[#9bc0e9] mt-[0.3rem]`}>
                      {stat.label}
                    </div>
                  </div>
                );
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-[236px_1fr] gap-[2.6rem] px-6 pt-[2.6rem] pb-12 items-start max-[900px]:grid-cols-1 max-[900px]:gap-0">
        <aside className="sticky top-[7.75rem] self-start max-[900px]:hidden">
          <div className={`${MONO} text-[0.64rem] tracking-[0.22em] uppercase text-[#5a6778] mb-[0.8rem]`}>
            On this page
          </div>
          {NAV_SECTIONS.map((section) => {
            ...
            return (
              <button
                ...
                className={`flex gap-[0.7rem] items-baseline py-2 pl-[0.9rem] pr-[0.2rem] text-[0.84rem] border-l-2 transition duration-200 tracking-[0.01em] cursor-pointer w-full text-left hover:text-[#1c2a3a] hover:border-l-[#5e97d5] ${
                  isActive
                    ? "text-red-500 border-l-red-500 font-medium"
                    : "text-[#5a6778] border-l-[#e3e8ee]"
                }`}
              >
                <span
        ...
        <div className="min-w-0">
          ...
          >
            ...
            <div>
              <p className="text-[#3f4a5b] leading-[1.6] mb-4">
          ...
          >
            ...
            <div>
              <p className="text-[#3f4a5b] leading-[1.6] mb-4">
                ...
                quad-core SoC running Android. It accepts a live HDMI video source
                (e.g. a cable set-top box or satellite receiver) and renders it
                alongside managed digital signage content, delivering a unified
                display experience on any 4K HDMI-connected commercial display.
              </p>
              <p className="text-[#3f4a5b] leading-[1.6] mb-4">
                The unit is housed in a custom CNC-machined aluminum enclosure
                rated IP54 for commercial environments. It ships with a
                UL-certified US power adapter, HDMI cable with ferrite cores, and
                a custom IR remote control — all packed in a branded retail-style
                carton box, ready for end-user installation.
          ...
          >
            ...
            <p className="text-[#3f4a5b] max-w-[74ch] leading-[1.6] mb-4">
            ...
            <ul className="list-none mt-[1.2rem] mb-0 p-0 grid grid-cols-2 gap-y-[0.1rem] gap-x-8 max-[640px]:grid-cols-1">
              {SCOPE_ITEMS.map((item, index) => (
                <li
                  ...
                  className={`relative py-[0.7rem] pl-[1.9rem] border-b border-[#e3e8ee] text-[#3f4a5b] text-base before:content-[''] before:absolute before:left-0 before:top-[1.05rem] before:w-[11px] before:h-[11px] before:border-2 before:border-red-500 before:rounded-[2px] after:content-[''] after:absolute after:left-[3px] after:top-[1.18rem] after:w-[5px] after:h-[5px] after:bg-red-500 after:rounded-[1px] after:transition-opacity after:duration-300 motion-reduce:after:transition-none ${
                    scopeVisible[index] ? "after:opacity-100" : "after:opacity-0"
                  }`}
                >
                  {item}
                </li>
              ...
              {CHALLENGES.map((row) => (
                ...
                >
                  <div className="bg-[#f8f8f8] py-4 px-[1.2rem] border-r-[3px] border-r-red-500 max-[680px]:border-r-0 max-[680px]:border-b-[3px] max-[680px]:border-b-red-500">
                    <div className={`${MONO} text-[0.6rem] tracking-[0.18em] uppercase text-red-500`}>
                      Challenge
                    </div>
                    <h4 className="text-base text-[#1c2a3a] font-medium tracking-[0.01em] leading-[1.15] mt-1">
                      {row.challenge}
                    </h4>
                  </div>
                  <div className="py-4 px-[1.2rem]">
                    <div className={`${MONO} text-[0.6rem] tracking-[0.18em] uppercase text-[#0a548f]`}>
                      Resolution
                    </div>
                    <p className="mt-1 mb-0 text-base text-[#3f4a5b] leading-[1.6]">
                      {row.resolution}
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-[0.8rem] mt-[1.2rem]">
              {HARDWARE_COMPONENTS.map((card) => (
                ...
                >
                  <h4 className="text-[0.95rem] text-[#1c2a3a] font-medium tracking-[0.01em] leading-[1.15] mb-[0.35rem] pl-[0.6rem]">
                    {card.title}
                  </h4>
                  <p className="text-base m-0 pl-[0.6rem] text-[#3f4a5b] leading-[1.6] text-left">
                    {card.description}
                  </p>
                </div>
              ))}
            ...
            <div className="mt-[1.2rem] grid relative before:content-[''] before:absolute before:left-[22px] before:top-2 before:bottom-2 before:w-0.5 before:bg-[#e3e8ee]">
              {FIRMWARE_ITEMS.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`${MONO} absolute left-0 top-0 w-[46px] h-[46px] rounded-full bg-white border-2 flex items-center justify-center text-[0.82rem] font-semibold z-[2] transition-all duration-[400ms] motion-reduce:transition-none ${
                        visible
                    ...
                    <h4 className="text-[1.02rem] text-[#1c2a3a] font-medium tracking-[0.01em] leading-[1.15] mb-1">
                      {item.title}
                    </h4>
                    <p className="text-base m-0 max-w-[78ch] text-[#3f4a5b] leading-[1.6]">
                      {item.description}
                    </p>
                  </div>
                );
          ...
          >
            ...
            <div className="mt-[1.2rem] bg-white border border-[#e3e8ee] rounded-lg overflow-hidden">
              {SPECS.map((row) => (
                ...
                >
                  <div className={`${MONO} text-[0.74rem] tracking-[0.04em] text-[#084676] py-[0.8rem] px-[1.1rem] bg-[#f8f8f8] border-r border-[#e3e8ee] font-medium max-[560px]:border-r-0 max-[560px]:border-b max-[560px]:border-b-[#e3e8ee]`}>
                    {row.key}
                  </div>
                  <div className="py-[0.8rem] px-[1.1rem] text-[#3f4a5b] text-base">
                    {row.value}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            <div
              ...
              className={`bg-[#1c2a3a] text-white rounded-lg py-[2.6rem] px-[2.2rem] mt-[1.4rem] relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(700px_280px_at_100%_-20%,rgba(46,120,191,0.35),transparent_60%)] transition-[opacity,transform] duration-700 ease-[ease] motion-reduce:transition-none motion-reduce:opacity-100 motion-reduce:translate-y-0 ${
                summaryVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
            >
              <div className="relative">
                <p className="text-[#cfe1f5] text-justify max-w-[82ch] leading-[1.6] mb-4">
                ...
                <p className="text-[#cfe1f5] text-justify max-w-[82ch] leading-[1.6] mb-4">
                  ...
                  over four years of continuous operation, the product stands
                  as a flagship reference for Qmax&apos;s concept-to-production
                ...
                <div className="text-[1.5rem] font-light text-white tracking-[0.03em] mt-[1.4rem] mb-[0.3rem]">
                  Qmax Systems:{" "}
                ...
                <div className="inline-flex items-center gap-[0.6rem] mt-4 text-[#9bc0e9] text-[0.95rem]">
      ...
      <footer className={`${MONO} text-center pt-8 px-6 pb-12 text-[#5a6778] text-[0.7rem] tracking-[0.12em]`}>
