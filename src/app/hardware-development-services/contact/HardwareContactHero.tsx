...
export default function HardwareContactHero() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setStatus("sending");
    try {
      await fetch("http://localhost:8080/api/email/contact", {
        method: "POST",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=2000&q=80")',
      ...
      <div className="max-w-[1320px] mx-auto px-8 sm:px-12 lg:px-24 xl:px-32">
        ...
        <div className="pt-10 lg:pt-14">
          <h1
            ...
            style={SOURCE_SANS}
          >
            <span className="block">Interested in Hardware Design?</span>
            <span className="block">Let&apos;s Talk!</span>
          </h1>
          <p className="text-[15px] font-medium leading-[1.5] text-white mt-4 mb-12">
            To learn more about how Qmax can help you, contact us. We&apos;d be
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_460px] gap-0 lg:gap-12 items-start">
          ...
          >
            ...
            {/* Stat 1 */}
            <div className="pb-7 border-b border-white/[18%]" ref={firstStatRef}>
              <div className={STAT_NUM} style={SOURCE_SANS}>25+</div>
              <div className={STAT_LABEL} style={SOURCE_SANS}>Years in Business</div>
              <p className={STAT_DESC}>
                Delivering electronics engineering and R&amp;D services since
                1997.
              </p>
            </div>

            {/* Stat 2 */}
            <div className="pb-7 border-b border-white/[18%]">
              <div className={STAT_NUM} style={SOURCE_SANS}>1000+</div>
              <div className={STAT_LABEL} style={SOURCE_SANS}>Completed Projects</div>
              <p className={STAT_DESC}>
                Across embedded systems, PCB design, and hardware development.
              </p>
            </div>

            {/* Stat 3 */}
            <div className="pb-7 border-b border-white/[18%]">
              <div className={STAT_NUM} style={SOURCE_SANS}>5+</div>
              <div className={STAT_LABEL} style={SOURCE_SANS}>Industries Served</div>
              <p className={STAT_DESC}>
                Industrial, communication, medical, automotive, and
            ...
            {/* Stat 4 */}
            <div ref={lastStatRef}>
              <div className={STAT_NUM} style={SOURCE_SANS}>100%</div>
              <div className={STAT_LABEL} style={SOURCE_SANS}>Customer Satisfaction</div>
              <p className={STAT_DESC}>
                Trusted long-term engineering partner with proven repeat-client
                engagements.
              </p>
            </div>
          </div>
