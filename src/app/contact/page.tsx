...
import { MapPin, Phone, Mail, Send, CheckCircle, ArrowRight, AlertCircle, RefreshCw } from "lucide-react";
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 border border-red-100">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <button
                        ...
                        disabled={loading}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-brand-red text-white rounded-full font-medium hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
