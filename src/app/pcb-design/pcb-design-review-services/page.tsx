    ...
    <main className="bg-[#0a0a0a] text-zinc-100">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-24 grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 border-t border-zinc-800 pt-16">
            ...
            <div className="space-y-12 text-xl leading-[1.6] text-zinc-400 font-light max-w-3xl">
              <p className="text-white font-normal text-2xl md:text-3xl leading-snug">
      ...
      <section className="bg-[#0a0a0a] py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative aspect-[21/9] w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-transparent to-transparent flex items-end p-8 md:p-16">
               <p className="text-xs font-black uppercase tracking-[0.4em] text-white/50">Production-Grade Technical Review</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="space-y-12 pt-4">
              <div className="border-l-2 border-zinc-800 pl-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                {[
                  { title: "Schematic Integrity", items: ["Netlist validation", "Component lifecycle checks"] },
                  { title: "Layout & SI", items: ["Trace impedance", "Return path integrity"] },
                  { title: "Regulatory", items: ["EMI/EMC readiness", "Safety clearances"] },
                  { title: "DFx", items: ["Manufacturing yield", "Assembly feasibility"] }
                ].map((category, idx) => (
                  <div key={idx} className="space-y-4">
                    <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#d9ff00]">{category.title}</h3>
                    <ul className="space-y-2">
                       {category.items.map((item, i) => (
                         <li key={i} className="text-sm text-zinc-500 font-medium">{item}</li>
                       ))}
                    </ul>
                  </div>
                ))}
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-24 text-left">
            ...
            <h2 className="text-4xl font-light text-white md:text-6xl lg:text-7xl tracking-tighter max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-8">
              ...
              <div className="mt-12 bg-zinc-900/50 border border-zinc-800 p-8">
                <span className="text-[10px] font-black tracking-[0.4em] text-white/40 block mb-4 uppercase">DELIVERABLE</span>
                <p className="text-[#d9ff00] font-light text-lg">
            ...
            <div className="space-y-16">
              <div className="relative aspect-video w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
                <Image
              ...
              <div className="space-y-8">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500">/ Scope of Review</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 group">
                  {[
                    { t: "Circuit Verification", d: "Power rail topology, signal path integrity, and feedback loop analysis." },
                    { t: "Component Validation", d: "Voltage/current ratings, temperature derating, and tolerance stack-up." },
                    { t: "Protection Circuits", d: "ESD, OVP, OCP, reverse-polarity, and thermal shutdown logic." },
                    { t: "Power Integrity", d: "Decoupling logic, bulk sizing, and LDO/DC-DC sequencing." },
                    { t: "Supervisory Review", d: "Power-on reset timing, watchdog enable, and brownout detection." },
                    { t: "Interface Compliance", d: "I2C/SPI pull-ups, UART accuracy, and differential termination." },
                    { t: "Clock Distribution", d: "Oscillator loading, fanout buffering, and PLL filter selection." },
                    { t: "Grounding & Isolation", d: "Chassis vs. digital ground, and galvanic isolation barriers." },
                    { t: "Annotation Quality", d: "RefDes, net labels, and title block accuracy for production." }
                  ].map((item, idx) => (
                    <div key={idx} className="group border-b border-zinc-900 pb-8 hover:border-zinc-800 transition-colors">
                      <h4 className="text-white text-lg font-light mb-3 group-hover:text-[#d9ff00] transition-colors">{item.t}</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 gap-1">
                {[
                  { s: "Functionality Review", d: "SI/PI checks, return path continuity, controlled-impedance stack-up, and high-speed net length matching." },
                  { s: "DFM — Manufacturing", d: "Trace width/spacing vs. fab minimums, via annular rings, copper pour relief, and panel utilization." },
                  { s: "DFA — Assembly", d: "Component courtyard clearance, SMD/THT mix strategy, IPC-7711 rework access, and fiducial placement." },
                  { s: "DFT — Testing", d: "Bed-of-nails test-point coverage, JTAG/SWD boundary-scan accessibility, and functional test placement." },
                  { s: "DFR — Reliability", d: "Via-in-pad treatment, copper-to-edge clearance, and BGA ball pitch vs. stack-up compatibility." },
                  { s: "DFS — Service", d: "Field-replaceable unit identification, connector labeling, and firmware update interface availability." }
                ].map((item, idx) => (
                  <div key={idx} className="group grid grid-cols-1 md:grid-cols-[200px_1fr] gap-8 py-8 border-t border-zinc-900 hover:bg-zinc-950 transition-colors px-4">
                    <h4 className="text-[#d9ff00] text-sm font-black uppercase tracking-widest">{item.s}</h4>
                    <p className="text-zinc-400 font-light leading-relaxed">{item.d}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-16">
              <div className="relative aspect-[3/4] w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
                <Image
              ...
              <div className="border-l border-zinc-800 pl-8">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 mb-6">/ Standards Applied</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="space-y-8 pt-8">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500">/ Internal Capabilities</h3>
                <div className="space-y-0 translate-x-[-1px]">
                  {[
                    ...
                    <div key={idx} className="flex items-start gap-6 border-t border-zinc-900 py-6 group hover:bg-zinc-950 px-4 transition-colors">
                      <span className="text-[#d9ff00] font-mono text-[10px] pt-1">0{idx + 1}</span>
                      <p className="text-lg text-zinc-400 font-light group-hover:text-zinc-200 transition-colors">{cap}</p>
                    </div>
                  ))}
                </div>
              </div>

              <div className="mt-12 bg-zinc-900/40 p-8 border border-zinc-800">
                <p className="text-sm text-zinc-500 italic mb-6">
                  Design data is reconstructed for legally permissible applications only.
                </p>
                <a 
                  href="/pcb-design" 
                  className="inline-flex items-center gap-2 text-[#d9ff00] group uppercase text-[10px] font-black tracking-widest border-b border-[#d9ff00] pb-2 hover:text-white hover:border-white transition-all"
                >
            ...
            <div className="space-y-16">
              <div className="relative aspect-[16/10] w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
                <Image
              ...
              <div className="border-l-2 border-[#d9ff00] pl-8">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 mb-6 block">FULL DOCUMENTATION PACKAGE</span>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 group">
                {[
                  { t: "PDF to EDA-Native", d: "Net-accurate, symbol-verified conversion from PDF schematics to Altium/Allegro." },
                  { t: "Scanned Drawing to CAD", d: "Digital reconstruction of paper-based schematics and mechanical drawings." },
                  { t: "Gerber to Database", d: "RS-274X + drill data to routed PCB layout database with verified net list." },
                  { t: "ODB++ to Native", d: "Full design database reconstruction from ODB++ manufacturing packages." },
                  { t: "Aperture Mapping", d: "Precise copper reconstruction and layer stackup definition for multilayer boards." },
                  { t: "Cross-Validation", d: "Net extraction validated against available BOM or schematic fragments." }
                ].map((item, idx) => (
                  <div key={idx} className="group border-b border-zinc-900 pb-8 hover:border-zinc-800 transition-colors">
                    <h4 className="text-white text-lg font-light mb-3 group-hover:text-[#d9ff00] transition-colors">{item.t}</h4>
                    <p className="text-sm text-zinc-500 leading-relaxed font-light">{item.d}</p>
              ...
              <div className="mt-12 bg-[#d9ff00]/5 p-8 border border-[#d9ff00]/10">
                <span className="text-[10px] font-black tracking-[0.4em] text-[#d9ff00] block mb-4 uppercase">VALIDATION POLICY</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="space-y-6 pt-4">
                 {[
                   ...
                   <div key={idx} className="flex items-center gap-4 text-zinc-500 hover:text-white transition-colors duration-300 group">
                      <div className="h-1 w-1 bg-[#d9ff00] rounded-full group-hover:w-4 transition-all" />
            ...
            <div className="space-y-16">
              ...
              <div className="border-l border-zinc-800 pl-8 space-y-6">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500">/ Translation Strategy</h3>
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900 border-b">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div className="space-y-12">
              <div>
                 <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#d9ff00] mb-8 block">PHASE 1.6 / BoM OPTIMIZATION</span>
                 <h2 className="text-4xl font-light text-white tracking-tighter mb-8 leading-tight">Cost Reduction & <br/> Obsolescence.</h2>
                 ...
                 <div className="space-y-6">
                    {[
                      ...
                      <div key={i} className="flex gap-4 items-center group">
                        <div className="h-[1px] w-4 bg-zinc-800 group-hover:bg-[#d9ff00] transition-colors" />
                        <span className="text-zinc-400 group-hover:text-white transition-colors font-light">{item}</span>
                      </div>
                    ))}
                 </div>
                 <div className="mt-12 bg-zinc-900/50 p-6 border border-zinc-800">
                    <p className="text-xs text-zinc-500 uppercase tracking-widest mb-2 font-black">DELIVERABLE</p>
                    <p className="text-sm text-zinc-300 font-light">Redlined BoM with lifecycle status, alternates, and cost delta analysis.</p>
                 </div>
              </div>
            </div>

            {/* Design Validation (1.7) */}
            <div className="space-y-12 border-l border-zinc-900 pl-4 lg:pl-12">
               <div>
                 <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#d9ff00] mb-8 block">PHASE 1.7 / DESIGN VALIDATION</span>
                 <h2 className="text-4xl font-light text-white tracking-tighter mb-8 leading-tight">DVT Planning & <br/> Execution.</h2>
                 <p className="text-zinc-500 font-light leading-relaxed mb-12">
                 ...
                 <div className="mt-12 bg-zinc-900/50 p-6 border border-zinc-800">
                    <p className="text-xs text-zinc-500 uppercase tracking-widest mb-2 font-black">DELIVERABLE</p>
                    <p className="text-sm text-zinc-300 font-light">Comprehensive DVT report with pass/fail status and corrective tracking.</p>
                 </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-zinc-900 pt-12">
                 <div className="space-y-6">
                    <h3 className="text-sm font-black text-[#d9ff00] uppercase tracking-widest">Domains Supported</h3>
                    <ul className="space-y-4">
                       {["CE Marking (EMC, LVD, RED)", "FCC Part 15B/15C/68", "IEC 61000 Series", "IEC 62368-1 / 60950-1"].map((s, i) => (
                         <li key={i} className="text-zinc-500 text-sm font-light border-b border-zinc-950 pb-2">{s}</li>
                       ))}
                    </ul>
                 </div>
                 <div className="space-y-6">
                    <h3 className="text-sm font-black text-[#d9ff00] uppercase tracking-widest">Remediation Types</h3>
                    <ul className="space-y-4">
                       {["Filter topology correction", "Guard trace & Plane revision", "Common-mode suppressions", "Firmware (Spread-spectrum)"].map((s, i) => (
                         <li key={i} className="text-zinc-500 text-sm font-light border-b border-zinc-950 pb-2">{s}</li>
                       ))}
                    </ul>
                 </div>
            ...
            <div className="space-y-16">
              <div className="relative aspect-square w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
                <Image
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="bg-[#d9ff00]/5 p-8 border-l-2 border-[#d9ff00]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               {[
                 { t: "Cyber Resilience Act (CRA)", d: "Full gap analysis for connected products." },
                 { t: "RoHS 3 (2015/863)", d: "Substance restriction impact assessment." },
                 { t: "EU Battery Reg (2023/1542)", d: "Design & documentation updates." },
                 { t: "ErP Directive", d: "Energy efficiency requirement updates." },
                 { t: "UKCA Marking", d: "Transition from CE for the UK market." },
                 { t: "FCC RF Device Security", d: "SDR and security requirement audits." }
               ].map((item, idx) => (
                 <div key={idx} className="border-t border-zinc-900 pt-8 group">
                    <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest mb-4">{item.t}</h3>
                    <p className="text-zinc-500 text-sm font-light leading-relaxed hover:text-white transition-colors">{item.d}</p>
                 </div>
               ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 group">
                {[
                  { t: "Mechanical Record", d: "Disassembly documentation with photographic evidence." },
                  { t: "PCBA Identification", d: "Component-level BoM extraction and source analysis." },
                  { t: "Process Assessment", d: "PCB class, assembly quality indicators, and coating audits." },
                  { t: "COGS Estimation", d: "Price-of-goods-sold estimation from component data." },
                  { t: "Thermal Strategy", d: "Approach documentation for thermal management." },
                  { t: "Software Inference", d: "Architecture inference from hardware observations." }
                ].map((item, idx) => (
                  <div key={idx} className="group border-b border-zinc-900 pb-8 hover:border-zinc-800 transition-colors">
                    <h4 className="text-white text-lg font-light mb-3 group-hover:text-[#d9ff00] transition-colors">{item.t}</h4>
                    <p className="text-sm text-zinc-500 leading-relaxed font-light">{item.d}</p>
            ...
            <div className="space-y-16">
              <div className="border-l border-zinc-800 pl-8 space-y-12">
                <div>
                   <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 mb-6">/ BENCHMARKING REPORT</h3>
                   <p className="text-zinc-600 font-light leading-relaxed">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="space-y-8 pt-8">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500">/ Migration Process</h3>
                <div className="space-y-6">
                  {[
                    { t: "Legacy System Audit", d: "Architecture, firmware dependencies, and interface inventory." },
                    { t: "Target Selection", d: "Processor benchmarking, BSP availability, and supply chain outlook." },
                    { t: "Hardware Re-design", d: "Schematic revision and power budget recalculation." },
                    { t: "Portability Assessment", d: "Toolchain migration, HAL layer changes, and RTOS compatibility." },
                    { t: "Regression Testing", d: "Development and execution of full functional equivalency tests." },
                    { t: "Production Qualification", d: "DVT and EMC re-validation for formal regulatory release." }
                  ].map((step, idx) => (
                    <div key={idx} className="flex gap-4 group">
                      <span className="text-[#d9ff00] text-xs font-black pt-1">/</span>
                      <div>
                        <h4 className="text-white font-medium mb-1 group-hover:text-[#d9ff00] transition-colors">{step.t}</h4>
                        <p className="text-sm text-zinc-500 font-light">{step.d}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-12 border-l-2 border-zinc-800 pl-8 space-y-6">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Common Scenarios</span>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 group">
                {[
                   { t: "Bare-Metal Porting", d: "ARM Cortex-M variants (M0/M0+/M3/M4/M7/M33/M55)." },
                   { t: "RTOS Migration", d: "FreeRTOS, Zephyr, ThreadX, uC/OS, VxWorks, Linux." },
                   { t: "HAL & BSP", d: "Re-implementation for target processor peripheral set." },
                   { t: "Driver Porting", d: "UART, SPI, I2C, CAN, Ethernet, USB, ADC, DAC, PWM, DMA." },
                   { t: "Stacks", d: "TCP/IP, MQTT, Modbus, CANopen, EtherCAT migration." },
                   { t: "Bootloaders", d: "Secure firmware update (FOTA/OTA) implementation." }
                ].map((item, idx) => (
                  <div key={idx} className="group border-b border-zinc-900 pb-8 hover:border-zinc-800 transition-colors">
                    <h4 className="text-white text-lg font-light mb-3 group-hover:text-[#d9ff00] transition-colors">{item.t}</h4>
                    <p className="text-sm text-zinc-500 leading-relaxed font-light">{item.d}</p>
            ...
            <div className="space-y-16">
              <div className="border-l-2 border-[#d9ff00] pl-8 space-y-12">
                <div>
                   <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 mb-6">/ COMPILER & ANALYSIS</h3>
                   <p className="text-zinc-400 font-light leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-4">
                   {["GCC / LLVM", "IAR EWARM", "Keil MDK", "Static Analysis"].map((t, i) => (
                     <div key={i} className="bg-zinc-900/50 p-4 border border-zinc-800 text-center text-[10px] font-black uppercase tracking-widest text-zinc-500 group hover:text-[#d9ff00] hover:border-[#d9ff00] transition-all">
                       {t}
                     </div>
                   ))}
                </div>
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900 border-b">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-24 items-end mb-24">
            <div>
              <span className="inline-block text-[10px] font-black uppercase tracking-[0.4em] text-[#d9ff00] mb-8">
                PARTNERSHIP / VALUE
              </span>
              <h2 className="text-4xl font-light text-white md:text-6xl lg:text-7xl tracking-tighter max-w-4xl">
                Why Qmax Systems <br/> for Design Review.
              </h2>
            </div>
            <p className="text-xl leading-relaxed text-zinc-500 font-light mb-4">
              Many design review engagements produce reports. Qmax Systems produces results. Our attributes define our practice.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start pt-16 border-t border-zinc-800">
            <div className="space-y-12">
               <div>
                  <h3 className="text-sm font-black uppercase tracking-[0.4em] text-[#d9ff00] mb-8">2.1 Engineering-Led Review</h3>
                  <p className="text-2xl text-white font-light leading-snug mb-8">
                    Not checklist compliance — we provide hands-on product development expertise.
                  </p>
                  <p className="text-lg text-zinc-400 font-light leading-relaxed">
                    Every review is conducted by senior engineers with direct development experience. Our reviewers have designed, debugged, tested, and manufactured the hardware they are reviewing.
                  </p>
               </div>
               <div className="space-y-6 border-l border-zinc-800 pl-8">
                  <p className="text-sm text-zinc-500 leading-relaxed font-light">
                    This background enables identification of non-obvious failure modes that automated DRC tools miss — including second-order EMI issues and thermal runaway conditions.
                  </p>
               </div>
            </div>

            <div className="relative aspect-[16/9] w-full overflow-hidden border border-zinc-800 transition-all duration-1000">
               <Image
                 src="/pcb-design-review-services/image2.png"
                 alt="Senior Engineering Design Review - Qmax Systems"
                 fill
                 className="object-cover"
               />
               <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/50 to-transparent flex items-end p-8">
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#d9ff00]">BEYOND AUTOMATED CHECKLISTS</span>
               </div>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 pt-24 border-t border-zinc-800">
            {/* Breadth (2.2) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.2 / Breadth Across the Stack</h3>
              <p className="text-zinc-400 font-light leading-relaxed">
            ...
            <div className="space-y-6 lg:col-span-2">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.3 / Standards-Grounded Methodology</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <p className="text-zinc-400 font-light leading-relaxed">
                ...
                <ul className="grid grid-cols-1 gap-2">
                   {[
                     ...
                     <li key={i} className="text-[10px] text-zinc-600 font-black uppercase tracking-wider flex items-center gap-2">
            ...
            {/* Actionable (2.4) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.4 / Actionable Deliverables</h3>
            ...
            {/* IP Protection (2.5) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.5 / Confidentiality & IP</h3>
              <p className="text-zinc-500 text-sm font-light leading-relaxed">
            ...
            {/* Turnaround (2.6) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.6 / Rapid Turnaround</h3>
              <p className="text-zinc-500 text-sm font-light leading-relaxed">
            ...
            {/* Scalable (2.7) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.7 / Scalable Engagement</h3>
              <p className="text-zinc-500 text-sm font-light leading-relaxed">
            ...
            {/* Track Record (2.8) */}
            <div className="space-y-6">
              <h3 className="text-[#d9ff00] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-900">2.8 / Proven Track Record</h3>
              <p className="text-zinc-500 text-sm font-light leading-relaxed">
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900 border-b relative overflow-hidden">
        {/* Subtle background element */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#d9ff00]/[0.02] -skew-x-12 translate-x-1/2 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start mb-32">
             <div className="space-y-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                   {/* What Happens */}
                   <div className="space-y-8">
                      <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 border-b border-zinc-900 pb-4">What Happens</h3>
                      <ul className="space-y-4">
                         {[
                            ...
                            <li key={i} className="flex gap-4 text-zinc-400 font-light text-sm">
                   ...
                   {/* Who Should Request */}
                   <div className="space-y-8">
                      <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 border-b border-zinc-900 pb-4">Who Should Attend</h3>
                      <ul className="space-y-4">
                         {[
                ...
                <div className="bg-zinc-900/40 p-12 border border-zinc-800">
                   <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 mb-8">How to Schedule</h3>
                   ...
                   <div className="flex flex-wrap gap-8 text-[10px] font-black uppercase tracking-widest text-[#d9ff00]">
                      <span className="flex items-center gap-2">
                         <div className="h-1 w-1 bg-[#d9ff00]" />
                         RESPONSE WITHIN 24H
                      </span>
                      <span className="flex items-center gap-2">
                         <div className="h-1 w-1 bg-[#d9ff00]" />
             ...
             <div className="space-y-12 lg:sticky lg:top-32">
                <div className="relative aspect-square w-full overflow-hidden border border-zinc-800 transition-all duration-1000 group">
                   <Image
                     src="/pcb-design-review-services/image1.png"
                ...
                <div className="bg-[#d9ff00] p-1 pt-0 group cursor-pointer">
                  <a href="/contact" className="bg-[#0a0a0a] block p-8 hover:bg-[#d9ff00] transition-colors group-hover:text-black">
                     <span className="text-xs font-black uppercase tracking-widest">REQUEST SESSION</span>
                     <div className="flex items-center justify-between mt-4">
                        <span className="text-2xl font-light">Contact Engineering</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-2 transition-transform"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                     </div>
                  </a>
                </div>
             </div>
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900 border-b">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-24 pt-12 border-t border-zinc-900 text-center lg:text-left">
             <a href="/pcb-design" className="text-zinc-500 hover:text-white transition-colors text-xs font-black uppercase tracking-widest border-b border-zinc-800 pb-2">
      ...
      <section className="bg-[#0a0a0a] py-32 border-t border-zinc-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { type: "Entrepreneurs", desc: "Bringing nascent hardware concepts to a state of manufacturing readiness." },
              { type: "Startups", desc: "Identifying critical failure modes before capital-intensive production runs." },
              { type: "Fortune 500s", desc: "Rigorous third-party audits for high-reliability industrial and defense platforms." }
            ].map((audience, idx) => (
              <div key={idx} className="group border-t border-zinc-800 pt-12 hover:bg-zinc-900/30 p-8 transition-colors">
                <span className="text-xs font-black text-[#d9ff00] tracking-[0.4em] mb-6 block">0{idx + 1}</span>
                <h3 className="text-2xl font-light text-white mb-6 group-hover:text-[#d9ff00] transition-colors">{audience.type}</h3>
