          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-8">
              ...
              <div className="mt-12 bg-zinc-100/50 border border-zinc-200 p-8">
                <span className="text-[10px] font-black tracking-[0.4em] text-zinc-400 block mb-4 uppercase">DELIVERABLE</span>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 group">
                  {[
                    ...
                    <div key={idx} className="group border-b border-zinc-100 pb-8 hover:border-zinc-300 transition-colors">
                      <h4 className="text-zinc-900 text-lg font-light mb-3 group-hover:text-[#F33117] transition-colors">{item.t}</h4>
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 gap-1">
                {[
                  ...
                  <div key={idx} className="group grid grid-cols-1 md:grid-cols-[200px_1fr] gap-8 py-8 border-t border-zinc-100 hover:bg-zinc-50 transition-colors px-4">
                    <h4 className="text-[#F33117] text-sm font-black uppercase tracking-widest">{item.s}</h4>
                    <p className="text-zinc-600 font-light leading-relaxed">{item.d}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="space-y-8 pt-8">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-400">/ Internal Capabilities</h3>
                <div className="space-y-0 translate-x-[-1px]">
                  {[
                    ...
                    <div key={idx} className="flex items-start gap-6 border-t border-zinc-100 py-6 group hover:bg-zinc-50 px-4 transition-colors">
                      <span className="text-[#F33117] font-mono text-[10px] pt-1">0{idx + 1}</span>
                      <p className="text-lg text-zinc-600 font-light group-hover:text-zinc-950 transition-colors">{cap}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-16">
              ...
              <div className="border-l-2 border-[#F33117] pl-8">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-6 block">FULL DOCUMENTATION PACKAGE</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-16 lg:gap-32 items-start">
            <div className="space-y-12">
              ...
              <div className="space-y-6 pt-4">
                 {[
                   ...
                   <div key={idx} className="flex items-center gap-4 text-zinc-500 hover:text-zinc-950 transition-colors duration-300 group">
            ...
            <div className="space-y-16">
              ...
              <div className="border-l border-zinc-200 pl-8 space-y-6">
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-400">/ Translation Strategy</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div className="space-y-12">
              <div>
                 ...
                 <h2 className="text-4xl font-light text-zinc-950 tracking-tighter mb-8 leading-tight">Cost Reduction & <br/> Obsolescence.</h2>
                 ...
                 <div className="space-y-6">
                    {[
                      ...
                      <div key={i} className="flex gap-4 items-center group">
                        ...
                        <span className="text-zinc-500 group-hover:text-zinc-950 transition-colors font-light">{item}</span>
                      </div>
                    ))}
                 </div>
                 <div className="mt-12 bg-zinc-100/50 p-6 border border-zinc-200">
                    <p className="text-xs text-zinc-400 uppercase tracking-widest mb-2 font-black">DELIVERABLE</p>
                    <p className="text-sm text-zinc-600 font-light">Redlined BoM with lifecycle status, alternates, and cost delta analysis.</p>
                 </div>
              </div>
            </div>
            ...
            <div className="space-y-12 border-l border-zinc-100 pl-4 lg:pl-12">
               <div>
                 ...
                 <h2 className="text-4xl font-light text-zinc-950 tracking-tighter mb-8 leading-tight">DVT Planning & <br/> Execution.</h2>
                 <p className="text-zinc-500 font-light leading-relaxed mb-12">
                 ...
                 <div className="mt-12 bg-zinc-100/50 p-6 border border-zinc-200">
                    <p className="text-xs text-zinc-400 uppercase tracking-widest mb-2 font-black">DELIVERABLE</p>
                    <p className="text-sm text-zinc-600 font-light">Comprehensive DVT report with pass/fail status and corrective tracking.</p>
                 </div>
              </div>
            </div>
                 ...
                 <div className="space-y-6">
                    ...
                    <ul className="space-y-4">
                       {["CE Marking (EMC, LVD, RED)", "FCC Part 15B/15C/68", "IEC 61000 Series", "IEC 62368-1 / 60950-1"].map((s, i) => (
                         <li key={i} className="text-zinc-500 text-sm font-light border-b border-zinc-200 pb-2">{s}</li>
                       ))}
                    </ul>
                 </div>
                 <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               {[
                 ...
                 <div key={idx} className="border-t border-zinc-200 pt-8 group">
                    ...
                    <p className="text-zinc-500 text-sm font-light leading-relaxed hover:text-zinc-950 transition-colors">{item.d}</p>
                 </div>
               ))}
            </div>
          </div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={idx} className="flex gap-4 group">
                      ...
                      <div>
                        <h4 className="text-zinc-900 font-medium mb-1 group-hover:text-[#F33117] transition-colors">{step.t}</h4>
              ...
              <div className="border-l-2 border-[#F33117] pl-8 space-y-12">
                ...
                <div className="grid grid-cols-2 gap-4">
                   {["GCC / LLVM", "IAR EWARM", "Keil MDK", "Static Analysis"].map((t, i) => (
                     <div key={i} className="bg-zinc-100/50 p-4 border border-zinc-200 text-center text-[10px] font-black uppercase tracking-widest text-zinc-400 group hover:text-[#F33117] hover:border-[#F33117] transition-all">
                       {t}
                     </div>
                   ))}
                </div>
      ...
      <section className="bg-[#fcfcfc] py-32 border-t border-zinc-200 border-b">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 pt-24 border-t border-zinc-200">
            {/* Breadth (2.2) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.2 / Breadth Across the Stack</h3>
              <p className="text-zinc-600 font-light leading-relaxed">
            ...
            <div className="space-y-6 lg:col-span-2">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.3 / Standards-Grounded Methodology</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <p className="text-zinc-600 font-light leading-relaxed">
                ...
                <ul className="grid grid-cols-1 gap-2">
                   {[
                     ...
                     <li key={i} className="text-[10px] text-zinc-500 font-black uppercase tracking-wider flex items-center gap-2">
            ...
            {/* Actionable (2.4) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.4 / Actionable Deliverables</h3>
            ...
            {/* IP Protection (2.5) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.5 / Confidentiality & IP</h3>
              <p className="text-zinc-600 text-sm font-light leading-relaxed">
            ...
            {/* Turnaround (2.6) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.6 / Rapid Turnaround</h3>
              <p className="text-zinc-600 text-sm font-light leading-relaxed">
            ...
            {/* Scalable (2.7) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.7 / Scalable Engagement</h3>
              <p className="text-zinc-600 text-sm font-light leading-relaxed">
            ...
            {/* Track Record (2.8) */}
            <div className="space-y-6">
              <h3 className="text-[#F33117] text-[10px] font-black uppercase tracking-widest pb-4 border-b border-zinc-200">2.8 / Proven Track Record</h3>
              <p className="text-zinc-600 text-sm font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-16 lg:gap-32 items-start mb-32">
             <div className="space-y-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                   {/* What Happens */}
                   <div className="space-y-8">
                      <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-400 border-b border-zinc-200 pb-4">What Happens</h3>
                      <ul className="space-y-4">
                         {[
                            ...
                            <li key={i} className="flex gap-4 text-zinc-600 font-light text-sm">
                   ...
                   {/* Who Should Request */}
                   <div className="space-y-8">
                      <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-400 border-b border-zinc-200 pb-4">Who Should Attend</h3>
                      <ul className="space-y-4">
                         {[
                ...
                <div className="bg-zinc-100/50 p-12 border border-zinc-200">
                   <h3 className="text-xs font-black uppercase tracking-[0.4em] text-zinc-400 mb-8">How to Schedule</h3>
             ...
             <div className="space-y-12 lg:sticky lg:top-32">
                ...
                <div className="bg-[#F33117] p-1 pt-0 group cursor-pointer">
                  <a href="/contact" className="bg-[#fcfcfc] block p-8 hover:bg-[#F33117] transition-colors group-hover:text-white">
                     <span className="text-xs font-black uppercase tracking-widest text-[#F33117] group-hover:text-white">REQUEST SESSION</span>
                     <div className="flex items-center justify-between mt-4">
                        <span className="text-2xl font-light text-zinc-950 group-hover:text-white">Contact Engineering</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-2 transition-transform text-[#F33117] group-hover:text-white"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                     </div>
                  </a>
                </div>
             </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="group border-t border-zinc-200 pt-12 hover:bg-zinc-50 p-8 transition-colors">
                <span className="text-xs font-black text-[#F33117] tracking-[0.4em] mb-6 block">0{idx + 1}</span>
                <h3 className="text-2xl font-light text-zinc-950 mb-6 group-hover:text-[#F33117] transition-colors">{audience.type}</h3>
