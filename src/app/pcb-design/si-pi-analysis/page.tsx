    ...
    <main className="bg-zinc-100 text-justify text-zinc-900">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-4xl space-y-6 text-sm leading-8 text-zinc-700 md:text-base lg:text-lg">
            ...
            <p>
              ...
              failure mechanisms are identified and engineered out before a
              board is sent to fabrication, not discovered during prototype
              bring-up.
            </p>
            <p>
              Our SI/PI engineering team has more than three decades of hands-on
              experience with the full spectrum of ultra-high-speed digital
              signaling: NRZ interfaces from 10Gbps to 56Gbps, PAM4 channels at
              56Gbps through 224Gbps per lane, multi-lane switch fabrics,
              complex DDR memory subsystems, and high-current power delivery
              networks for AI compute, data centre networking, and server
              platforms.
            </p>
            <p>
              SI/PI analysis is available both as a standalone engineering
              service and as an integrated component of our PCB Design and
              Hardware Development programs. All design IP, simulation data, and
              deliverables remain the sole intellectual property of the
              customer.
            </p>
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-b border-zinc-200">
        <div className="mx-auto max-w-4xl text-zinc-800">
          ...
          <div className="mt-6 flex flex-col gap-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <p>
              Modern PCB design operating above 1Gbps per lane is an applied
              electromagnetic engineering discipline. As signal edge rates
              shrink below 50 picoseconds and PAM4 modulated lanes carry 112Gbps
              or 224Gbps of data, the physical PCB becomes a transmission-line
              network where every via transition, anti-pad geometry, reference
              plane discontinuity, laminate dielectric property, and decoupling
              capacitor placement directly determines system functional margin.
              A board that passes visual inspection and DRC can still fail
              first-pass bring-up because of an under-specified stackup, an
              unmodelled via stub resonance, or an inadequate PDN that collapses
              under peak transient load.
            </p>
            <p>
              SI and PI are tightly coupled disciplines that Qmax treats as a
              single engineering system, not two separate checks. PDN switching
              noise injected into reference planes raises the noise floor at
              high-speed receivers, directly degrading eye diagram margin.
              Ground bounce from simultaneous switching outputs (SSO) across a
              high-density ASIC I/O bank adds jitter to differential SerDes
              lanes sharing the same power domain. A well-designed PDN with
              sub-milliohm AC impedance from DC through the GHz regime is as
              critical to achieving a clean PAM4 eye diagram as controlling the
              channel insertion loss (SDD21) and near-end crosstalk (NEXT).
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-zinc-50 px-6 py-16 md:py-24 lg:px-8 border-b border-zinc-200">
        <div className="mx-auto max-w-4xl text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            interface. At Qmax Systems, SI analysis covers the full chain from
            silicon pad to silicon pad:
          </p>
          <ul className="mt-10 space-y-8 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Transmission-line impedance control and controlled-impedance
                stackup:
              </span>{" "}
              Every high-speed net is modelled as a distributed transmission
            ...
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Via stub resonance analysis and back-drill specification:
              </span>{" "}
              Unterminated via stubs below the last active signal connection act
              as quarter-wave resonators. Stub resonant frequency is governed by
              stub length and local dielectric constant. At PCIe Gen6 (64GT/s
              PAM4) or 112G PAM4 Ethernet, stubs longer than 8–12 mils on
              standard server board thicknesses create insertion loss notches
              within the signalling bandwidth, failing COM (Channel Operating
              Margin) requirements. Qmax performs via stub analysis for every
              design above 16GT/s and specifies controlled-depth back-drilling
              accordingly.
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                End-to-end IBIS-AMI channel simulation:
              </span>{" "}
              For NRZ interfaces at PCIe Gen5 speeds and all PAM4 interfaces,
              eye diagram simulation requires IBIS-AMI models that capture
              transmitter FFE (Feed-Forward Equalization), receiver CTLE
              (Continuous Time Linear Equalization), and DFE (Decision Feedback
              Equalization) behaviour accurately. We obtain these models
              directly from silicon vendors and run statistical eye simulations
              (QuickEye / StatEye) to extract eye height, eye width, and BER
              bathtub curves referenced against the specification compliance
              mask.
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                COM (Channel Operating Margin) analysis:
              </span>{" "}
              For PCIe Gen5/6 and 112G/224G PAM4 Ethernet, channel compliance is
            ...
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Crosstalk extraction and mixed-mode S-parameter analysis:
              </span>{" "}
            ...
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              ...
              Time-domain reflectometry simulation generates an
              impedance-versus-time profile of a signal path, revealing BGA
              fanout via mismatches, anti-pad geometry effects, connector
              footprint discontinuities, and reference plane transitions. TDR
              simulation is used iteratively to refine via design rules before
              they are locked into the PCB constraint file.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8">
        <div className="mx-auto max-w-4xl text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            harmonic emissions that cause EMI compliance failures.
          </p>
          <ul className="mt-10 space-y-8 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">DC IR drop analysis:</span> Static
              DC current distribution is simulated across copper pours, plane
              splits, via arrays, and connector contacts to map voltage drop
              across the board. For multi-phase CPU VCC rails exceeding 200A,
              GPU power domains at 300–700W, or high-current bus converters in
              power electronics systems, IR drop analysis identifies hotspots,
              optimises copper pour geometry and weight, and ensures node
              voltages remain within the silicon vendor&apos;s specified
              tolerance across all load conditions.
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                PDN AC impedance profiling and anti-resonance suppression:
              </span>{" "}
              The PDN presents a frequency-dependent impedance to each load.
              Resonant peaks between bulk electrolytic capacitors, ceramic
              decoupling capacitors, and PCB plane inductance create supply
              voltage spikes when the load switches. We simulate PDN impedance
            ...
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Decoupling capacitor optimisation:
              </span>{" "}
              Capacitor placement is a quantitative calculation, not a rule of
              thumb. We calculate the effective mounted inductance (ESL) of each
              capacitor location based on via count, land geometry, and distance
              to the device power pads, then select C0G/NP0 or X7R capacitor
              values to achieve broadband PDN coverage. For CPU and GPU
              packages, on-die capacitance (Cdie) and package inductance (Lpkg)
              are incorporated into the PDN model using silicon-vendor-supplied
              package parasitic data.
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Power plane resonance and EBG analysis:
              </span>{" "}
              Power-ground plane pairs form a parallel-plate resonant cavity.
              Cavity resonances at frequencies determined by board dimensions
              and Dk create PDN impedance peaks that peripheral decoupling
              capacitors cannot suppress. Where resonances fall within the PDN
              bandwidth of concern, we apply EBG (Electromagnetic Band Gap)
              structures, resistive plane edge termination, or plane
              segmentation.
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                High-current trace and via current capacity:
              </span>{" "}
              Trace current density is analysed against IPC-2152 for all
              power-carrying conductors, accounting for copper weight, ambient
              temperature, and thermal management. Via arrays in high-current
              paths are calculated for aggregate current capacity including
              temperature derating. This is particularly critical for power
              electronics boards, heavy copper designs (4oz+), and AI
              accelerator power delivery networks.
            </li>
          </ul>
        </div>
      </section>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    <th scope="col" className="w-1/3 px-6 py-4 text-zinc-900">
                      Capability
                    </th>
                    <th scope="col" className="px-6 py-4 text-zinc-900">
                      Qmax Advantage
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200">
                  ...
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Direct technical collaboration with tier-1 PCB fabricators
                      to define stackup constructions, obtain
                      fabricator-measured Dk/Df data at frequency, confirm
                      back-drill depth tolerance, and validate DFM feasibility
                      before design is finalised. We have maintained these
                      fabricator relationships for over 30 years across North
                  ...
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      SI and PI are never analysed in isolation. PDN noise
                      coupling into SI channels, ground bounce degrading eye
                      margins, and thermal effects on Dk shift are all accounted
                      for in the analysis workflow.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top">
                    ...
                    <td className="px-6 py-5 align-top">
                      All simulation files, extracted models, constraint files,
                      and reports are customer property, delivered in
                      industry-standard formats (Touchstone .sNp, SPICE, PDF,
                      native tool files).
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      SI/PI work is conducted with EMI/EMC pre-compliance in
                      mind from day one. Return path integrity, decoupling
                      strategies, and mode conversion suppression are aligned
                      with CE, FCC, CISPR, and automotive CISPR 25 requirements.
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            interface data rates, PCB material selection recommendation,
            critical net identification, preliminary PDN target impedance
            definition, via back-drill requirements, decoupling pre-placement
            strategy, and component placement guidelines for SI-critical
            devices. This early-stage review significantly reduces the
            probability of post-layout SI/PI failures that require stackup
            changes or critical net re-routing.
          </p>
              ...
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    <th
                      scope="col"
                      className="w-[30%] px-6 py-4 text-zinc-900 border-r border-zinc-200/50"
                    >
                      Interface / Standard
                    </th>
                    <th
                    ...
                    <th scope="col" className="w-[40%] px-6 py-4 text-zinc-900">
                ...
                <tbody className="divide-y divide-zinc-200">
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      COM analysis per PCI-SIG CEM Spec, PAM4 three-eye mask
                      compliance, ICN budget across x16 lane bundles, back-drill
                      optimisation for 64GT/s, DFE tap co-optimisation, CXL 3.x
                      memory fabric channel analysis
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      OIF CEI-112G channel compliance, FEC gain budget, SNDR
                      optimisation, 8-tap FFE + 24-tap DFE modelling, QSFP-DD /
                      OSFP connector S-parameter extraction, host board via
                      transition 3D EM analysis
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Ultra-low IL budget channel modelling, package co-design
                      at board interface, advanced CDR jitter tolerance
                      analysis, co-design with silicon vendor pre-production
                      models
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Per-pin DQ eye simulation, DFE-assisted receiver margin,
                      VDDQ PDN AC impedance, RDIMM/LRDIMM buffer insertion, SSO
                      noise analysis for 64-bit bus, thin HDI via transition for
                      LPDDR5X
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      100Ω differential (D-PHY) / trio impedance (C-PHY),
                      intra-pair skew, ESD TVS capacitance loading on eye
                      margin, fine-pitch BGA via model extraction, automotive
                      ADAS platform compliance
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Dual-role port channel SI, cable assembly channel
                      extension, ESD / EMC filter loading on eye, compliance
                      with USB IF and Thunderbolt specifications
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      IEEE 802.3 channel compliance mask, full backplane IL and
                      NEXT/FEXT extraction, connector and press-fit via
                      modelling
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Inter-GPU differential channel SI over long board traces
                      (up to 600mm), connector and cable channel extension
                      modelling, co-design with NVIDIA platform guidelines
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <div className="mt-6 flex flex-col gap-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <p>
              The industry transition from NRZ (binary, 2-level) to PAM4
            ...
            <p>
              COM (Channel Operating Margin) analysis per IEEE 802.3 and PCI-SIG
      ...
      <section className="bg-zinc-50 px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <div className="mt-6 flex flex-col gap-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <p>
              PCB laminate material selection is one of the most consequential
              decisions in high-speed board design. The dielectric constant (Dk)
              and dissipation factor (Df) of the laminate directly determine
              ...
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    <th
                      scope="col"
                      className="w-[25%] px-6 py-4 text-zinc-900 border-r border-zinc-200/50"
                    >
                      Material Property
                    </th>
                    <th
                      scope="col"
                      className="w-[45%] px-6 py-4 text-zinc-900 border-r border-zinc-200/50"
                    >
                      SI Significance
                    </th>
                    <th scope="col" className="w-[30%] px-6 py-4 text-zinc-900">
                ...
                <tbody className="divide-y divide-zinc-200">
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50">
                      Primary source of dielectric insertion loss. Higher Df =
                      higher loss per unit length. The most critical parameter
                      for channels above 16GT/s.
                    </td>
                    <td className="px-6 py-5 align-top">
                  ...
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50">
                      Skin effect at high frequency confines current to the
                      conductor surface; rougher copper extends the effective
                      path length, increasing conductor loss. Standard (STD ED)
                      foil imposes 30–50% excess conductor loss vs. HVLP at
                      10GHz.
                    </td>
                    <td className="px-6 py-5 align-top">
                      <ul className="space-y-1">
                        ...
                        <li className="mt-2 text-zinc-500 italic">
                          HVLP mandatory for 56G+ channels.
                        </li>
                      </ul>
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50">
                      Periodic glass fiber structure creates spatially varying
                      local Dk beneath routed traces (fiber weave effect),
                      causing differential pair skew and mode conversion
                      (SCD21). Resin-rich constructions (RC &gt; 70%) and
                      1080/1067 weave styles reduce the Dk variation amplitude.
                    </td>
                    <td className="px-6 py-5 align-top">
                      <ul className="space-y-1">
                        <li>
                          ...
                          Coarse weave, higher skew risk
                        </li>
                        <li>
                          <span className="font-medium text-zinc-800">
                            1080/1067:
                          </span>{" "}
                          Tighter weave preferred
                        </li>
                        <li className="mt-2 text-zinc-500 italic">
                          RC &gt; 70% prepregs specified for high-speed layers.
                        </li>
                      </ul>
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50">
                      Absorbed moisture shifts Dk/Df, degrading SI performance
                      in humidity. Low-absorption laminates required for
      ...
      <section className="bg-zinc-50 px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
              ...
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="w-[35%] px-6 py-4 text-zinc-900 border-r border-zinc-200/50"
                    >
                      Laminate Recommendation
                    </th>
                    <th scope="col" className="w-[35%] px-6 py-4 text-zinc-900">
                      Key Selection Basis
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200">
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Moderate Df acceptable. Standard FR-4 class.
                      Cost-optimised.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Df &le;0.005 at 10GHz required. VLP copper foil specified.
                      Megtron 6 is the production standard at this tier.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50 text-zinc-600">
                      Panasonic Megtron 6 / Megtron 7, Isola Tachyon 100G,
                      Ventec VT-901
                    </td>
                    <td className="px-6 py-5 align-top">
                      Df &le;0.003 at 10GHz mandatory. HVLP copper required.
                      Tight Dk tolerance (&plusmn;0.05) specified. Resin-rich
                      prepregs for all critical signal layers.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50 text-zinc-600">
                      Panasonic Megtron 7, Isola Tachyon 100G, Taconic TLY,
                      experimental laminates
                    </td>
                    <td className="px-6 py-5 align-top">
                      Ultra-low Df (&le;0.0025 at 10GHz). HVLP copper with
                      Huray/Hammerstad roughness model in simulation.
                      Co-designed with fabricator on material lot basis.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Stable Dk vs. frequency. Low Df for mmWave content. Hybrid
                      stackup construction with fabricator engineering team.
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <p className="mx-auto mt-8 max-w-[80rem] text-sm leading-7 text-zinc-600 md:text-base italic">
          ...
          as part of the stackup specification document, and confirmed as
          processable by the fabricator before design release.
        </p>
      </section>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-[80rem] text-zinc-800">
          ...
          <p className="mt-6 max-w-5xl text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            2D/RLGC extraction for pre-layout feasibility through full 3D EM
            extraction and statistical IBIS-AMI eye simulation for final
            verification.
          </p>
          <div className="mt-10 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    ...
                    <th scope="col" className="w-[45%] px-6 py-4 text-zinc-900">
                      Application
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200">
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Pre-layout impedance calculation, trace width/spacing
                      optimisation, differential pair geometry for Ztarget
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Via stub resonance, BGA fanout via S-parameter extraction,
                      connector SDD21/SDD11, back-drill depth optimisation,
                      anti-pad geometry
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      End-to-end statistical eye diagram with TX FFE / RX CTLE /
                      DFE models from silicon vendors. BER bathtub curve, jitter
                      budget.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top border-r border-zinc-200/50 text-zinc-600">
                      IEEE 802.3 COM MATLAB reference tool, vendor-specific COM
                      platforms
                    </td>
                    <td className="px-6 py-5 align-top">
                      PCIe Gen5/6 and 112G/224G PAM4 channel pass/fail per IEEE
                      COM. ICN, ISI, and equalization co-optimisation.
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Full-board DC current distribution, plane hotspot mapping,
                      via current density, multi-rail co-simulation
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 font-medium text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      PDN impedance vs. frequency, anti-resonance
                      identification, decoupling capacitor sweep and placement
                      optimisation
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Impedance profiling of critical nets, discontinuity
                      identification, correlation with physical TDR measurements
                      at bring-up
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Termination network simulation, PDN transient response
                      under load step, SSO noise, power sequencing analysis
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <div className="mt-16">
            ...
            <p className="mt-4 text-base leading-8 text-zinc-700 md:text-lg text-justify">
              ...
              eyes characteristic of PAM4 signalling are visible. The
              probability density heatmap (red = highest density) confirms clean
              eye opening. Eye height and width are evaluated against the
              specification compliance mask to establish pass/fail margin for
              the channel.
            </p>
          ...
          <div className="mt-24">
            ...
            <p className="mt-4 text-base leading-8 text-zinc-700 md:text-lg text-justify">
              ...
              pad impedance dip requiring an anti-pad void under the SoC pad to
              recover the 95&Omega; differential target; a via transition
              impedance peak corrected by adjusting the via and anti-pad
              geometry; and a P/N differential pair separation causing impedance
              rise to 100&Omega;, corrected by maintaining matched P/N via
              spacing. This iterative TDR-guided optimisation is performed for
              all critical via types before design rules are locked.
            </p>
            <div className="mt-8 overflow-hidden rounded-2xl shadow-xl shadow-zinc-900/10 ring-1 ring-zinc-200/50">
              <Image
          ...
          <div className="mt-24">
            ...
            <p className="mt-4 text-base leading-8 text-zinc-700 md:text-lg text-justify">
              ...
              lanes with a reference marker at 8GHz Nyquist. Worst-case SDD21 at
              8GHz: &minus;15.86dB; worst-case SDD11: &minus;9.85dB. These
              values are assessed against the applicable IEEE or JEDEC channel
              compliance mask to determine pass/fail margin and &mdash; where
              insufficient margin exists &mdash; to drive back-drill depth,
              trace length, or material changes.
            </p>
            <div className="mt-8 overflow-hidden rounded-2xl shadow-xl shadow-zinc-900/10 ring-1 ring-zinc-200/50">
              <Image
          ...
          <div className="mt-24">
            ...
            <p className="mt-4 text-base leading-8 text-zinc-700 md:text-lg text-justify">
              ...
              &minus;80.68dB. These NEXT values are inputs to the COM ICN
              calculation &mdash; the statistical aggregate of all crosstalk
              contributions at the receiver. For PAM4 channels, where each eye
              opening is approximately 9.5dB smaller than an equivalent NRZ eye,
              maintaining NEXT and FEXT below the ICN budget is a primary
              routing discipline constraint.
            </p>
            <div className="mt-8 overflow-hidden rounded-2xl shadow-xl shadow-zinc-900/10 ring-1 ring-zinc-200/50">
              <Image
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-[80rem] text-zinc-800">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link
              href="#"
              className="inline-flex items-center justify-center rounded-full bg-blue-600 px-6 py-3 text-sm text-white shadow-sm transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 whitespace-nowrap"
            >
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                802.3, COM analysis for PAM4 lanes, QSFP28 host board via
                transition 3D EM extraction, PDN analysis for Ethernet switch
                ASICs with 50A+ switching current demands. Retimer placement and
                channel loss budget optimisation for reach extension.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                server-class board thicknesses. IBIS-AMI simulation with
                silicon-validated FFE/CTLE/DFE models from Intel, AMD, Broadcom,
                and Qualcomm. ICN budget management across x16 lane bundles in
                high-lane-count switch and NIC designs. PDN analysis for PCIe
                Gen6 switch ICs on AI accelerator fabrics. All prior PCIe
                generations (Gen3/4/5) are covered as a subset of this
                capability.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                analysis, ESD protection TVS device capacitance loading on eye
                margin, fine-pitch BGA via model extraction for mobile and
                automotive ADAS camera SoC platforms. Co-analysis with Qualcomm,
                MediaTek, and NXP platform design guidelines.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                PDN AC impedance profiling with RDIMM/LRDIMM buffer models, SSO
                noise analysis for 64-bit data bus simultaneous switching.
                Point-to-point LPDDR5X routing SI on thin HDI PCBs for mobile
                SoC platforms.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                VRM output transient response for 300A/&mu;s load steps typical
                of high-core-count server processors. PDN analysis for power
                electronics boards with heavy copper (4oz+) and bus bars.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                ...
                zone. Inter-socket UPI/xGMI SI analysis across full board
                dimensions. Thermal-PDN co-simulation incorporating power plane
                temperature rise under sustained peak CPU workloads.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-3xl border border-zinc-200 bg-zinc-50/50 p-8 sm:p-10 transition-shadow hover:shadow-md md:col-span-2">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600 max-w-4xl">
                ...
                step transient simulation, Broadcom and Marvell switch ASIC
                power domain PI. NVLink/NVSwitch inter-GPU differential channel
                SI over long board traces with cable assembly channel extension.
                Thermal-PDN co-simulation for sustained AI training workloads.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-zinc-50 px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <div className="mt-6 flex flex-col gap-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <p>
              The most common cause of first-prototype SI/PI failures is a
              mismatch between simulation assumptions and the actual
              manufactured board and device behaviour. Qmax Systems eliminates
              this through direct, engineering-level relationships with both
              silicon vendors and PCB fabricators &mdash; relationships built
              and maintained over more than 30 years of collaborative program
              execution.
            </p>
          </div>
                ...
                <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                  <thead className="bg-zinc-100/80">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="w-[70%] px-6 py-4 text-zinc-900"
                      >
                        Collaboration Scope
                      </th>
                    </tr>
                  ...
                  <tbody className="divide-y divide-zinc-200">
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                        Broadcom
                      </td>
                      <td className="px-6 py-5 align-top">
                        PCIe Gen4/5/6 IBIS-AMI models, Ethernet PHY SI platform
                        guidelines, Trident/Tomahawk switch SI validation
                        checklists. BGA fanout via optimisation as shown in TDR
                        Figure 2.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        Xeon/Core PCIe Gen5 CEM SI guidelines, DDR5 memory
                        subsystem design rules, EMIB/Foveros package interface
                        models, VR12.5 PDN co-design specifications.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        EPYC/Ryzen PCIe Gen5 SI validation, MI-series GPU power
                        delivery PDN specifications, DDR5 memory interface
                        design rules, LRDIMM channel simulation models.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        Snapdragon LPDDR5X SI routing guidelines, MIPI CSI-2
                        D-PHY/C-PHY models, automotive ADAS platform SI/PI
                        design packages, 5G co-existence SI.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        Layerscape/S32 PCIe/DDR SI guides, automotive Ethernet
                        100BASE-T1/1000BASE-T1 channel models, CAN-FD physical
                        layer SI.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        Altra/AmpereOne PCIe Gen4/5 SI guidelines, DDR4/DDR5
                        memory subsystem rules, cloud-native compute platform
                        PDN specifications.
                      </td>
                    </tr>
                    <tr className="transition-colors hover:bg-zinc-50/50">
                      ...
                      <td className="px-6 py-5 align-top">
                        Dimensity LPDDR5/5X SI routing rules, UFS/PCIe interface
                        design guides, Wi-Fi 7 co-existence SI.
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="mt-16">
            ...
            <p className="mt-4 text-base leading-8 text-zinc-700 md:text-lg text-justify">
              ...
              test coupon data from prior production runs on the same
              construction to calibrate simulation models; confirming HVLP or
              VLP copper foil availability and lamination process compatibility;
              reviewing back-drill depth tolerance achievable on the target via
              drill diameter; and validating HDI blind/buried via aspect ratios
              for fine-pitch BGA signal escapes. Etch factor compensation
              &mdash; the difference between artwork trace width and post-etch
              conductor width &mdash; is characterised per process and
              incorporated into impedance simulation, as this affects target
              impedance by 2&ndash;5&Omega; and is a common source of
              first-build impedance miss.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            performed as the project kick-off activity.
          </p>
          <ul className="mt-10 space-y-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              ...
              source series resistor values, AC-coupled termination networks,
              ODT configuration versus channel topology and target reach
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Decoupling topology review:</span>{" "}
              ferrite bead selection, bulk and ceramic capacitor value strategy
              per power domain, VRM output filter network adequacy
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                Clock distribution SI review:
              </span>{" "}
              driver type (LVDS/LVPECL/CML), fan-out topology, stub elimination
              strategy, reference plane requirements
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">
                SerDes configuration review:
              </span>{" "}
              TX pre-emphasis and de-emphasis settings, RX CTLE/DFE register
              configuration compatibility with channel loss budget
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Power sequencing review:</span>{" "}
              VRM enable sequence compliance with silicon vendor power-on timing
              requirements
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Component lifecycle review:</span>{" "}
              decoupling capacitors, termination resistors, and clock buffers in
      ...
      <section className="bg-zinc-50 px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-5xl text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            ...
            requirements and provide direct technical input on:
          </p>
          <ul className="mt-10 space-y-6 text-base leading-8 text-zinc-700 md:text-lg text-justify">
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Interface feasibility:</span>{" "}
              target data rate versus proposed stackup and channel length
              &mdash; passive channel, retimer, or redriver?
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Material selection</span>{" "}
              recommendation based on interface speed and insertion loss budget
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Back-drill requirement:</span>{" "}
              does your board thickness and data rate combination require
              controlled-depth drilling?
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">PDN complexity assessment:</span>{" "}
              VRM co-design requirements and Ztarget estimate
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Simulation methodology:</span>{" "}
              2D/RLGC, full 3D EM via extraction, or IBIS-AMI statistical eye
              &mdash; what does your channel require?
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Fabricator guidance:</span> which
              fabricators can process your target laminate and back-drill
              specification
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Risk identification:</span> the
              interfaces and power delivery items most likely to cause
              first-pass failure
            </li>
            <li className="relative pl-6 before:absolute before:left-0 before:top-[0.6rem] before:h-2 before:w-2 before:rounded-full before:bg-zinc-900">
              <span className="text-zinc-900">Review</span> of any existing
              bring-up failures, TDR anomalies, or eye diagram compliance issues
            </li>
          </ul>
          ...
          <div className="mt-14 space-y-6">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-zinc-900 px-8 py-4 text-base text-white shadow-lg transition-transform hover:scale-105 hover:bg-zinc-800 hover:shadow-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900 whitespace-nowrap"
            >
              ...
              <table className="min-w-full divide-y divide-zinc-200 text-left text-sm leading-7 text-zinc-700 md:text-base">
                <thead className="bg-zinc-100/80">
                  <tr>
                    ...
                    <th scope="col" className="w-[70%] px-6 py-4 text-zinc-900">
                      Content
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200">
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Per-channel SDD21/SDD11 plots, eye diagram with mask
                      overlay, IBIS-AMI bathtub BER curve, COM result, timing
                      margin summary, pass/fail vs. specification limit
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      AC PDN impedance plots DC&ndash;1GHz+ per domain, Ztarget
                      overlay, anti-resonance annotation, decoupling capacitor
                      BOM and placement coordinates
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Full-board voltage distribution maps per rail, max/min
                      voltage annotation, hotspot identification, copper
                  ...
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Impedance vs. time for critical nets, discontinuity
                      identification with corrective action notes, BGA fanout
                      via optimisation results
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Layer stack with dielectric thickness, copper weight,
                      material, controlled impedance table with tolerance, glass
                      style and copper foil type per layer, fabricator-confirmed
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      HFSS/CST-extracted Touchstone .s4p S-parameter files for
                      all critical via types, calibrated to fabricator process
                      data
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      Native PCB tool constraint files (Allegro / Altium /
                      Zuken) with differential pair rules, length matching
                      windows, impedance rules, via rules &mdash; pre-populated
                      for layout engineer use
                    </td>
                  </tr>
                  <tr className="transition-colors hover:bg-zinc-50/50">
                    <td className="px-6 py-5 text-zinc-900 align-top border-r border-zinc-200/50">
                    ...
                    <td className="px-6 py-5 align-top">
                      All native simulation project files delivered as customer
                      IP (Ansys SIwave/HFSS, Cadence Sigrity, HSpice) for future
                      design reuse
                    </td>
                  </tr>
                </tbody>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8 border-t border-zinc-200">
        <div className="mx-auto max-w-4xl text-center text-zinc-800">
          ...
          <p className="mt-6 text-base leading-8 text-zinc-700 md:text-lg">
            ...
            Qmax Systems has the engineering depth, silicon vendor
            relationships, and fabricator partnerships to ensure your design is
            correct before it is built.
          </p>

          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
            <Link
              href="/contact"
              className="inline-flex w-full sm:w-auto items-center justify-center rounded-full bg-blue-600 px-8 py-3.5 text-sm text-white shadow-sm transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
            >
              Schedule 1-Hour Consultation
            </Link>
            <Link
              href="/contact"
              className="inline-flex w-full sm:w-auto items-center justify-center rounded-full bg-zinc-900 px-8 py-3.5 text-sm text-white shadow-sm transition-colors hover:bg-zinc-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900"
            >
              Request a Technical Quote
            </Link>
            <Link
              href="/contact"
              className="inline-flex w-full sm:w-auto items-center justify-center rounded-full border border-zinc-200 bg-white px-8 py-3.5 text-sm text-zinc-900 shadow-sm transition-colors hover:bg-zinc-50 hover:text-zinc-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900"
            >
          ...
          <div className="mt-8 flex justify-center items-center gap-4 text-sm text-zinc-500">
            <span className="text-zinc-700">Qmax Systems</span>
            <span className="text-zinc-300">|</span>
            <Link
