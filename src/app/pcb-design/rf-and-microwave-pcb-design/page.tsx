...
const coreServiceOfferings: HighSpeedCoreOffering[] = [
  {
    ...
    headline:
      "Comprehensive RF and microwave PCB design from MHz to 80 GHz.",
    intro:
  ...
  return (
    <>
      <HardwareServiceHeroSection
        imageSrc="https://images.unsplash.com/photo-1517420704952-d9f39e95b43e?w=1600&h=900&fit=crop&q=80"
        ...
        description={
          <>
            <p>
              ...
              PCB routing. At frequencies from hundreds of MHz to millimeter-wave
              bands, the PCB becomes part of the RF circuit itself. Trace
              geometry, dielectric loss, via transitions, grounding topology,
              shielding strategy, and impedance discontinuities directly
              influence insertion loss, phase stability, noise floor, and EMI
              compliance.
            </p>
            <p>
