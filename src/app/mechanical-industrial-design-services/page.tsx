...
import {
  ...
  type CapabilityCardV2,
} from "@/components/services-cmp/CapabilitiesSectionV2";
...
const CAPABILITIESV2: CapabilityCardV2[] = [
  {
    ...
    image: {
      src: "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/SDR/SDR_RENDERING_11_JAN_2025_S1.1.png",
      alt: "Rugged mechanical enclosure design for electronics hardware",
    },
    icon: (
      <svg
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    image: {
      src: "https://d1yetprhniwywz.cloudfront.net/v2/case-studies/mechanical/OBD/10April2022TekionOBD.1.png",
      alt: "Industrial design product enclosure with refined form and finish",
    },
    icon: (
      <svg
        viewBox="0 0 24 24"
