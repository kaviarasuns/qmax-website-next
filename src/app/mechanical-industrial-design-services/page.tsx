      ...
      <section className="relative overflow-hidden pt-14 pb-12 border-b border-zinc-200 lg:pt-20 lg:pb-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-4xl space-y-4 text-sm leading-7 text-zinc-700 md:text-base">
            <p>
              At Qmax Systems, we understand that an electronics product is more
              than just a functional PCB; it is a physical entity that must
              survive its environment, satisfy user ergonomics, and meet
            ...
            <p>
              ...
              mechanical execution. We focus on the critical intersection of PCB
              mechanical integration, thermal management, and structural
              integrity to ensure your product is reliable, manufacturable, and
              aesthetically aligned with your brand identity.
            </p>
            <p>
              ...
              (Design for Manufacturing) and DFA (Design for Assembly) from day
              one, reducing iteration cycles and ensuring that your enclosure is
              not just a box, but a high-performance component of your overall
              system.
            </p>
          </div>
        </div>
