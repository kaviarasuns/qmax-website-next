      ...
      <div className="w-full px-8 md:px-12">
        <div className="mb-10 flex flex-col items-end justify-between gap-6 md:flex-row md:items-start">
          <div className="max-w-2xl">
            <h2 style={{ fontFamily: "'Supermolot', sans-serif" }} className="mb-3 text-3xl font-bold tracking-tight text-foreground md:text-4xl lg:text-5xl">Case <span className="text-red-500">Studies</span></h2>
