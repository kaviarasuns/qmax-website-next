      ...
      <div className="relative w-full h-[60vh] md:h-[75vh] group overflow-hidden border-b border-zinc-800 -mt-24 mb-16 shadow-2xl">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full max-w-7xl px-4 sm:px-6 lg:px-8 z-20 pointer-events-none flex justify-between items-end">
          <div className="space-y-4">
            ...
            <div className="font-mono text-[10px] text-emerald-500 tracking-[0.4em] uppercase">
              Mechanical Engineering / Primary Node
            </div>
          </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl mb-24 relative">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-medium tracking-tighter text-white uppercase leading-[0.9] mb-8">
            ...
            <span className="text-zinc-500 italic font-serif lowercase">
              mechanical
            </span>{" "}
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6 text-xl text-zinc-300 font-light leading-relaxed">
              ...
              <div className="pl-6 border-l-2 border-emerald-900/50 space-y-8 py-2">
                <p>
                  Every enclosure, structural assembly, and mechanical
                  sub-system we design is conceived with{" "}
                  <span className="text-white">
                    full awareness of the electronics inside it
                  </span>{" "}
                  - thermal loads, EMI shielding requirements, PCB mounting
                  constraints, connector accessibility, and compliance
                  obligations.
                </p>
                <p>
                  We maintain active working relationships with sheet metal
                  fabricators, CNC machining houses, and plastic injection
                  moulding companies globally. Prototype or volume production -
                  we select the right manufacturing partner based on material,
                  tolerance, finish, and cost.
                </p>
              </div>

              <p className="text-lg text-muted-foreground">
                All test facilities required - IP ingress testing, vibration and
                shock testing to MIL-STD-810, and radiated emission testing -
              ...
              <div className="relative bg-[#0a0a0a] p-8 rounded-md border border-zinc-800">
                <div className="flex items-center gap-3 mb-4 font-mono text-xs uppercase tracking-widest text-emerald-500">
                  ...
                  >
                    ...
                    <path d="M3 9h3v6H3zM18 9h3v6h-3zM5.5 3h13M5.5 21h13" />
                  </svg>
                  <span>GD&T Standards Rigour</span>
                </div>
                <p className="text-zinc-200 font-medium leading-relaxed">
                  All mechanical design work is fully documented with clear,
                  unambiguous GD&T on every drawing, ensuring any qualified
                  vendor can manufacture to specification without
                  interpretation.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8 flex flex-col justify-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              <div className="p-8 border border-zinc-800 bg-zinc-900/30 flex flex-col gap-3 group hover:border-emerald-500/30 transition-colors">
                ...
                <span className="text-3xl text-zinc-200 font-light tracking-tighter">
                  ±0.01<span className="text-zinc-500 text-sm ml-1">mm</span>
                </span>
                <p className="text-xs leading-relaxed font-light text-muted-foreground">
                  High-precision solid modeling for tight-tolerance assemblies.
                </p>
              </div>
              <div className="p-8 border border-zinc-800 bg-zinc-900/30 flex flex-col gap-3 group hover:border-emerald-500/30 transition-colors">
                <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-[0.2em]">
                ...
                <span className="text-3xl text-zinc-200 font-light tracking-tighter uppercase">
                  MIL-STD
                </span>
                <p className="text-xs leading-relaxed font-light text-muted-foreground">
                  810 Qualified designs for vibration, shock, and thermal
                  extremes.
                </p>
              </div>
            </div>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white ">
              <span className="text-zinc-500 italic font-serif">Plastic</span>{" "}
              <br className="hidden md:block" /> Enclosure Design
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
            ...
            <div className="lg:col-span-7 space-y-10">
              <p className="text-xl text-zinc-300 font-light leading-relaxed">
                ...
                , industrial handheld devices, and cost-sensitive IoT products.
                Qmax Systems designs injection-moulded plastic enclosures that
                balance structural integrity, thermal performance, EMI
                management, and tooling cost - with a clear path from concept to
                mass production.
              </p>
              ...
              <div>
                ...
                <p className="leading-relaxed font-light text-muted-foreground">
                  Our enclosure design process covers draft angles, parting line
                  placement, wall thickness uniformity, rib and boss geometry,
                  snap-fit and living hinge design, insert moulding for threaded
                  interfaces, and EMI gasket seating. For RF-transparent
                  products (Wi-Fi, 4G, GPS), we analyse dielectric properties
                  and wall thickness effects on signal attenuation. Surface
                  finish options - texture, gloss, painting, soft-touch coating,
                  pad printing, in-mould labelling - are specified during the
                  design phase.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-[#0e0e0e] border border-zinc-800 rounded-lg p-8 relative overflow-hidden group">
              ...
              <ul className="relative space-y-3 font-mono text-sm">
                ...
                <li className="flex items-start gap-4 p-4 border border-zinc-800/50 hover:border-emerald-500/30 hover:bg-emerald-900/10 transition-colors rounded-sm">
                  ...
                  <span className="text-zinc-300 leading-relaxed">
                    Nylon (PA6 / PA66) & glass-filled engineering variants
                  </span>
                </li>
                <li className="flex items-start gap-4 p-4 border border-zinc-800/50 hover:border-emerald-500/30 hover:bg-emerald-900/10 transition-colors rounded-sm">
                  <span className="text-emerald-500 mt-0.5">03</span>
                  <span className="text-zinc-300 leading-relaxed">
                    Teflon (PTFE) for specialised chemical or dielectric
                    applications
                  </span>
                </li>
                <li className="flex items-start gap-4 p-4 border border-zinc-800/50 hover:border-emerald-500/30 hover:bg-emerald-900/10 transition-colors rounded-sm">
                  ...
                  <span className="text-zinc-300 leading-relaxed">
                    UV-stabilised grades, flame-retardant UL94-V0 compliant
                    materials
                  </span>
                </li>
              </ul>
          ...
          <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
              <h2 className="text-4xl md:text-5xl font-light text-white  uppercase">
                Selected{" "}
                <span className="text-zinc-500 italic font-serif lowercase">
                  Portfolio
                </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
                ...
                <h3 className="text-xl text-white font-medium mb-4 pr-12">
                  Wi-Fi Security Device Enclosure
                </h3>
                <ul className="space-y-3 font-light text-zinc-400">
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1 text-[10px] opacity-70">
                      {"///"}
                    </span>
              ...
              <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
                ...
                <ul className="space-y-3 font-light text-zinc-400">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Robust drop resistance & ergonomic grip geometry
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1 text-[10px] opacity-70">
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white ">
              <span className="text-zinc-500 italic font-serif">Metal</span>{" "}
              <br className="hidden md:block" /> Enclosures
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 03
            </div>
          ...
          <div className="space-y-12">
            <p className="max-w-4xl text-xl text-zinc-300 font-light leading-relaxed">
              ...
              , higher structural rigidity, thermal conductance, or a longer
              service life under mechanical or environmental stress. Qmax
              designs and sources all three principal metal enclosure types.
            </p>
              ...
              <table className="w-full text-left border-collapse font-sans">
                <thead>
                  <tr className="bg-zinc-900/50 border-b border-zinc-800">
                    <th className="p-6 font-mono text-xs uppercase tracking-widest text-emerald-500">
                      Type
                    </th>
                    <th className="p-6 font-mono text-xs uppercase tracking-widest text-emerald-500">
                      Typical Application
                ...
                <tbody className="divide-y divide-zinc-800 text-sm md:text-base">
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-medium underline decoration-emerald-500/20 underline-offset-8">
                    ...
                    <td className="p-6 text-zinc-300">
                      Tight tolerances, complex geometry, excellent EMI
                      shielding
                    </td>
                  </tr>
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    ...
                    <td className="p-6 text-zinc-300">
                      Cost-effective for mid-volume, good structural-to-weight
                      ratio
                    </td>
                  </tr>
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    ...
                    <td className="p-6 text-zinc-300">
                      Integral heat sink geometry, excellent thermal path, low
                      per-unit cost
                    </td>
                  </tr>
                </tbody>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight">
              ...
              <br className="hidden md:block" /> Surface Treatments
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 04
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="space-y-6">
              <h3 className="font-mono text-xs uppercase tracking-widest text-emerald-500 border-l border-emerald-500 pl-4">
                Core Alloys
              </h3>
          ...
          <div className="max-w-3xl p-6 bg-zinc-900/30 border border-zinc-800 rounded-sm italic text-zinc-400 font-light leading-relaxed flex gap-4 items-start">
            ...
            <p>
              ...
              applicable{" "}
              <span className="text-white not-italic font-medium underline decoration-emerald-500/30 underline-offset-4">
                MIL-SPEC surface treatment standards
              </span>
              .
            </p>
          </div>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight uppercase">
              ...
              <br className="hidden md:block" /> Military Rugged Enclosures
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 05
            </div>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
              <div className="lg:col-span-12 space-y-8">
                <h3 className="text-2xl text-white font-medium">
                  Rugged Metal Enclosures for Military Applications -
                  MIL-STD-810 / JSS 55555
                </h3>
                <p className="max-w-5xl text-xl text-zinc-300 font-light leading-relaxed">
                  ...
                  helicopters, and altitude. Mechanical designs for these
                  environments must be validated against formal test standards
                  before fielding.
                </p>
                <div className="p-6 bg-emerald-950/10 border border-emerald-900/30 rounded-sm">
                  <p className="text-zinc-300 leading-relaxed font-light">
                    Qmax Systems designs rugged enclosures to{" "}
                    <span className="text-white font-medium underline decoration-emerald-500/20 underline-offset-4">
                      MIL-STD-810H
                    </span>{" "}
                    and{" "}
                    <span className="text-white font-medium underline decoration-emerald-500/20 underline-offset-4">
                    ...
                    , with full documentation supporting test qualification.
                    Structural analysis is performed before hardware is built,
                    reducing prototype-test cycles.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4">
                <div className="text-emerald-500 uppercase tracking-widest text-[10px]">
                  Approach // 01
                </div>
              ...
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4">
                ...
                <p className="text-zinc-200">
                  Conformal sealed interfaces; EMI gasket seating (finger stock,
                  wire mesh)
                </p>
              </div>
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4">
              ...
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4">
                ...
                <p className="text-zinc-200">
                  Thermal management integration; MIL-connector cutouts to
                  specification
                </p>
              </div>
            </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
                ...
                <h3 className="text-xl text-white font-medium mb-4 pr-12 text-zinc-200">
                ...
                <ul className="space-y-3 text-sm font-light text-zinc-400 border-l border-emerald-900/50 pl-4 font-mono uppercase  text-[11px]">
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight uppercase">
              ...
              <br className="hidden md:block" /> IP-Rated Enclosures
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 06
            </div>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
              <div className="lg:col-span-8 space-y-8">
                ...
                <p className="text-xl text-zinc-300 font-light leading-relaxed">
                  Ingress protection ratings under{" "}
                  <span className="text-white font-medium">IEC 60529</span>{" "}
                  govern resistance to solid particulates (first digit) and
                  liquid ingress (second digit). IP65 provides dust-tight
                  protection with resistance to water jets. IP67 permits
                  temporary immersion to 1 metre for 30 minutes. IP68 is
                  specified for continuous immersion, with exact conditions
                  agreed between manufacturer and customer.
                </p>
                <div className="p-6 bg-emerald-950/10 border border-emerald-900/30 rounded-sm">
                  <p className="text-zinc-300 leading-relaxed font-light">
                    Achieving a given IP rating is a mechanical engineering
                    problem. It requires correct selection and compression of
                    sealing elements, proper surface flatness and roughness at
                    sealing interfaces, appropriate fastener torque
                    specifications, cable entry gland selection, and connector
                    IP rating matching.
                  </p>
                </div>
              </div>
            ...
            <div className="overflow-x-auto border border-zinc-800 rounded-lg bg-zinc-900/20">
              <table className="w-full text-left border-collapse font-sans">
                ...
                <tbody className="divide-y divide-zinc-800 text-sm md:text-base">
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-mono font-medium">
                      IP65
                    </td>
                  ...
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    ...
                    <td className="p-6 text-zinc-400 font-light">Dust-tight</td>
                    <td className="p-6 text-zinc-300">
                      Continuous immersion (specified depth)
                    </td>
                    <td className="p-6 text-zinc-400 font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 bg-[#0e0e0e] border border-zinc-800 p-8 rounded-sm">
              ...
              <div className="md:col-span-8 space-y-6 text-zinc-300 font-light leading-relaxed">
                <p>
                  ...
                  <span className="text-white">silicone, EPDM, Viton</span> -
                  are selected based on temperature range, chemical exposure,
                  and compression set requirements.
                </p>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight uppercase">
              ...
              <br className="hidden md:block" /> Full Mechanical Systems
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 07
            </div>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
              <div className="lg:col-span-8 space-y-8">
                ...
                <p className="text-xl text-zinc-300 font-light leading-relaxed">
                  ...
                  system design for products that include{" "}
                  <span className="text-white font-medium">
                    moving parts, mechanisms, electromechanical actuation
                  </span>
                  , or complex multi-body assemblies. Our capability spans
                  kinematic design and mechanism analysis through detailed part
                  design, assembly drawing sets, and BOM for procurement.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4 group">
                <div className="text-emerald-500 font-mono uppercase tracking-widest text-[10px] mb-2">
                  Capability // 01
                </div>
                <h4 className="text-white font-medium transition-colors group-hover:text-emerald-400">
                  Mechanism Design & Kinematics
                </h4>
                <p className="font-light text-xs leading-relaxed text-muted-foreground">
                  Linkage geometry, cam and follower, pivot and hinge design,
                  actuation force analysis, and travel limits.
                </p>
              </div>
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4 group">
                <div className="text-emerald-500 font-mono uppercase tracking-widest text-[10px] mb-2">
                ...
                <p className="font-light text-xs leading-relaxed text-muted-foreground">
                  Motor and actuator mounting, encoder alignment, and precision
                  harness routing within mechanical sub-systems.
                </p>
              </div>
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4 group">
                <div className="text-emerald-500 font-mono uppercase tracking-widest text-[10px] mb-2">
                ...
                <p className="font-light text-xs leading-relaxed text-muted-foreground">
                  Mechanical design of high-precision optical assemblies and
                  rigid mounting structures for sensitive sensor payloads.
                </p>
              </div>
              <div className="p-6 border border-zinc-800 bg-zinc-900/40 font-mono text-sm space-y-4 group">
                <div className="text-emerald-500 font-mono uppercase tracking-widest text-[10px] mb-2">
                ...
                <p className="font-light text-xs leading-relaxed text-muted-foreground">
                  EMI-segregated routing, custom strain relief design, and bend
                  radius compliance for high-reliability harness sets.
                </p>
              </div>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
                  ...
                  <h3 className="text-xl text-white font-medium mb-4 pr-12 text-zinc-200">
                    Foot Switch for Ophthalmic Surgery
                  </h3>
                  <p className="font-light text-sm leading-relaxed mb-6 text-muted-foreground">
                    Ergonomic, ultra-high-precision foot switch for eye cataract
                    surgery equipment with calibrated actuation force and
                    travel.
                  </p>
                  <ul className="space-y-3 text-sm font-light text-zinc-400 border-l border-emerald-900/50 pl-4 font-mono uppercase  text-[11px]">
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-500/70">+</span>
                      <span>
                        IP-rated, CE-marked design for sterile environments
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight uppercase">
              ...
              <br className="hidden md:block" /> DFx Disciplines
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 08
            </div>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
              <div className="lg:col-span-8 space-y-8">
                <h3 className="text-2xl text-white font-medium italic">
                  Design for Manufacturability, Cost, Assembly & Compliance
                </h3>
                <p className="text-xl text-zinc-300 font-light leading-relaxed">
                  A mechanical design that cannot be manufactured repeatably and
                  economically is not a finished design. Qmax applies{" "}
                  <span className="text-white font-medium underline decoration-emerald-500/20 underline-offset-4">
                    DFx disciplines
                  </span>{" "}
                  throughout the design process - as concurrent engineering that
              ...
              <table className="w-full text-left border-collapse font-sans">
                <thead>
                  <tr className="bg-zinc-900/50 border-b border-zinc-800">
                    ...
                    <th className="p-6 font-mono text-xs uppercase tracking-widest text-emerald-500 w-2/3">
                      What We Address
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-800 text-sm md:text-base">
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-mono font-medium underline decoration-emerald-500/20 underline-offset-8">
                      DFM - Manufacturability
                    </td>
                    <td className="p-6 text-zinc-300 font-light leading-relaxed">
                      Tolerances set to process capability. Features designed to
                      the manufacturing method. Tooling complexity minimised.
                    </td>
                  </tr>
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-mono font-medium underline decoration-emerald-500/20 underline-offset-8">
                    ...
                    <td className="p-6 text-zinc-300 font-light leading-relaxed">
                      Material selection, process route, finish specification,
                      and fastener standardisation evaluated for BOM cost.
                    </td>
                  </tr>
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-mono font-medium underline decoration-emerald-500/20 underline-offset-8">
                    ...
                    <td className="p-6 text-zinc-300 font-light leading-relaxed">
                      Part count minimisation, self-locating features, fastener
                      access, tooling access, and assembly sequence reviewed.
                    </td>
                  </tr>
                  <tr className="group hover:bg-emerald-950/5 transition-colors">
                    <td className="p-6 text-white font-mono font-medium underline decoration-emerald-500/20 underline-offset-8">
                    ...
                    <td className="p-6 text-zinc-300 font-light leading-relaxed">
                      RoHS, REACH, CE marking, MIL, JSS, IEC, ISO addressed at
                      design stage, not at submission.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="relative p-1 bg-gradient-to-br from-zinc-800 to-zinc-950 rounded-lg group mt-16">
              ...
              <div className="relative bg-[#0a0a0a] p-8 rounded-md border border-zinc-800 flex flex-col md:flex-row gap-8 items-center lg:items-start text-center md:text-left">
                <div className="shrink-0 p-4 bg-zinc-900 border border-zinc-800 rounded-sm">
                  ...
                  <div className="font-mono text-[10px] text-zinc-600 mt-2 uppercase tracking-tighter">
                    ISO 286 / ASME Y14.5
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <p className="text-zinc-200 font-medium leading-relaxed max-w-4xl">
                    ...
                    GD&T-annotated drawing set prepared to{" "}
                    <span className="text-white">ISO 286 / ASME Y14.5</span>{" "}
                    standards. Drawing packages include part drawings, assembly
                    drawings, BOM, material callouts, surface finish callouts,
                    and applicable standard references. Any competent machine
                    shop or toolmaker can manufacture from our drawings without
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-zinc-800 pb-8 gap-6">
            <h2 className="text-4xl md:text-5xl font-light text-white  leading-tight uppercase">
              ...
              <br className="hidden md:block" /> Thermal & Structural Analysis
            </h2>
            <div className="font-mono text-xs text-zinc-500 uppercase tracking-widest bg-zinc-900/50 px-3 py-1 border border-zinc-800">
              Spec Sheet // 09
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
              <div className="lg:col-span-8 space-y-8">
                <p className="text-xl text-zinc-300 font-light leading-relaxed">
                  ...
                  and{" "}
                  <span className="text-white font-medium">
                    CFD-informed thermal analysis
                  </span>{" "}
                  to identify and eliminate failure modes before hardware is
                  fabricated.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <p className="font-light leading-relaxed italic text-muted-foreground">
                  ...
                  convection, forced convection, and conduction-cooled
                  assemblies.
                </p>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex gap-3 text-xs font-mono text-zinc-500 uppercase tracking-wider items-start"
                    >
              ...
              <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-sm self-start">
                <p className="text-zinc-300 font-light leading-relaxed italic border-l-2 border-emerald-500/30 pl-6">
                  ...
                  thickness, rib placement, fastener torque, vibration isolator
                  stiffness, and PCB support boss location. Where analysis
                  predicts a compliance risk, the design is modified before the
                  prototype is built. Physical testing then confirms the
            ...
            <div className="space-y-8 mt-12">
              ...
              <div className="overflow-x-auto border border-zinc-800 rounded-lg bg-zinc-900/10">
                <table className="w-full text-left border-collapse font-sans">
                  <thead>
                    <tr className="bg-zinc-900/50 border-b border-zinc-800">
                      <th className="p-4 font-mono text-xs uppercase tracking-widest text-emerald-500">
                        Analysis Type
                      </th>
                      <th className="p-4 font-mono text-xs uppercase tracking-widest text-emerald-500">
                        Standard / Method
                      </th>
                      <th className="p-4 font-mono text-xs uppercase tracking-widest text-emerald-500 w-1/2">
                        Output
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-zinc-800 text-[13px] md:text-sm">
                    {[
                      {
                        type: "Static Stress",
                        method: "FEA (linear / non-linear)",
                        output:
                          "Safety factors, stress concentrations, deflection maps",
                      },
                      {
                        type: "Modal Analysis",
                        method: "FEA eigenvalue extraction",
                        output:
                          "Natural frequencies, mode shapes, resonance risk",
                      },
                      {
                        type: "Vibration (Sinusoidal)",
                        method: "MIL-STD-810H / DO-160",
                        output: "Stress response, fatigue life estimate",
                      },
                      {
                        type: "Vibration (Random)",
                        method: "PSD input, MIL-STD-810 / JSS 55555",
                        output: "RMS stress, component reliability prediction",
                      },
                      {
                        type: "Mechanical Shock",
                        method: "MIL-STD-810H Method 516.8",
                        output: "Peak response, fastener survivability",
                      },
                      {
                        type: "Drop Test Analysis",
                        method: "IEC 60068-2-31, Custom spec",
                        output:
                          "Impact force, energy absorption, failure prediction",
                      },
                    ].map((row, idx) => (
                      <tr
                        key={idx}
                        className="group hover:bg-emerald-950/5 transition-colors"
                      >
                        <td className="p-4 text-white font-medium underline decoration-emerald-500/20 underline-offset-8">
                          {row.type}
                        </td>
                        <td className="p-4 text-zinc-400 font-mono italic">
                          {row.method}
                        </td>
                        <td className="p-4 text-zinc-300 font-light leading-snug">
                          {row.output}
                        </td>
                      </tr>
                    ))}
            ...
            <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
              ...
              <ul className="space-y-3 text-sm font-light text-zinc-400">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Qualified for vibration, shock, temperature, and humidity
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Weight optimisation alongside full RF shielding integrity
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
              ...
              <ul className="space-y-3 text-sm font-light text-zinc-400">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Integrated EMI suppression & antenna keep-out zones
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Optimised for maximum Wi-Fi throughput and low tooling cost
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="group relative bg-[#0e0e0e] border border-zinc-800 p-8 hover:border-emerald-500/50 transition-colors duration-500">
              ...
              <ul className="space-y-3 text-sm font-light text-zinc-400">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Ergonomic grip geometry with robust drop resistance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500/70">{"///"}</span>
                  <span>
                    Complex internal RF coordination for workshop environments
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="w-full mt-32 border-t border-zinc-800/50 pt-20">
          <div className="mb-12 border-b border-zinc-800 pb-8">
            ...
            <p className="font-light mt-4 max-w-2xl text-muted-foreground">
              ...
              automotive, defence, and medical electronics companies.
            </p>
          </div>
              ...
              <tbody className="divide-y divide-zinc-800 text-[13px] md:text-sm">
                {[
                  ...
                  },
                  {
                    ...
                    challenge:
                      "Shipborne, 3-axis motion compensation in salt-laden environment",
                  },
                  {
                    sector: "Medical",
                    product: "Ophthalmic Surgery Foot Switch",
                    challenge:
                      "Precision actuation, medical-grade, IP-rated surgical device",
                  },
                  {
                    sector: "IoT / Security",
                  ...
                  },
                  {
                    ...
                    challenge:
                      "Workshop-grade, workshop drop rating, ergonomic grip",
                  },
                ].map((row, idx) => (
                  <tr
                    key={idx}
                    className="group hover:bg-emerald-950/5 transition-colors"
                  >
                    <td className="p-4 text-zinc-500 font-mono text-[10px] uppercase tracking-widest">
                      {row.sector}
                    </td>
          ...
          <div className="relative border border-emerald-500/20 bg-emerald-950/10 p-12 md:p-16 rounded-sm text-center max-w-4xl mx-auto space-y-10 group overflow-hidden">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl text-white font-medium ">
                1-Hour Complimentary <br className="hidden md:block" />{" "}
            ...
            <p className="text-zinc-300 text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto">
              Bring your mechanical design challenge to a working session with a
              Qmax senior mechanical engineer. We will review your requirements,
              identify critical design decisions, and outline a realistic path
              to a compliant, manufacturable product.
            </p>
        ...
        <footer className="w-full mt-40 pt-20 border-t border-zinc-800/50 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl font-light text-white  uppercase leading-tight">
                Start a{" "}
                <span className="text-zinc-500 italic font-serif lowercase">
                  Mechanical Design
                </span>{" "}
              ...
              <p className="text-xl font-light leading-relaxed max-w-xl text-muted-foreground">
                Whether you have a full specification or an early-stage concept,
                the right time to engage a mechanical design team is before the
                electronics layout is frozen - not after.
              </p>
            </div>
