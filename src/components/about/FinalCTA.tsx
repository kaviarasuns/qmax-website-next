      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl leading-relaxed max-w-2xl mx-auto text-foreground">
            Partner with Qmax to engineer your next breakthrough product.
            Whether you need embedded systems design, PCB design, or full-cycle
            product development, we&apos;re ready to deliver.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Link
              ...
              className="border-2 border-black hover:bg-black/10 font-semibold px-8 py-3 rounded-md transition-colors flex items-center justify-center gap-2"
            >
              <Download size={18} />
