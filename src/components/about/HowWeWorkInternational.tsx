      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {badges.map((badge, index) => (
            <span
              key={index}
              className="px-4 py-2 bg-red-50 border border-red-500 rounded-md text-sm font-medium text-red-500 transition-colors duration-200 hover:bg-red-500 hover:text-white"
            >
              {badge}
            </span>
          ))}
