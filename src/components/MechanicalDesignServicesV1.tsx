        ...
        <main className="bg-zinc-100 text-zinc-900">
                ...
                <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 md:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-stretch lg:px-8">
                    <div>
                        ...
                        <h1 className="mt-6 text-4xl font-semibold leading-tight text-zinc-900 md:text-5xl">
                            Precision Mechanical Engineering for Electronics Products
                        </h1>
                    ...
                    <div className="relative h-full min-h-[300px] overflow-hidden rounded-2xl border border-zinc-200 bg-white md:min-h-[420px]">
                        <Image
                            ...
                            alt="Precision Mechanical Engineering for Electronics"
                            fill
                                    ...
                                    <ul className="space-y-3">
                                        {[
                                            ...
                                            <li key={idx} className="flex items-start gap-3 group">
                                                ...
                                                <span className="text-sm text-zinc-700 leading-relaxed">{material}</span>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
                                        <h4 className="text-base font-semibold text-zinc-900 mb-2">Wi-Fi Security Device Enclosure</h4>
                                        <p className="text-sm leading-6 text-zinc-600">
                                            Low tooling cost, integrated EMI suppression geometry, antenna keep-out zones for maximum Wi-Fi throughput.
                                        </p>
                                    </div>
                                    <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
                                        <h4 className="text-base font-semibold text-zinc-900 mb-2">Handheld OBD2 Diagnostic Device</h4>
                                        <p className="text-sm leading-6 text-zinc-600">
                                ...
                                <table className="w-full text-left text-sm border-collapse">
                                    <thead>
                                        <tr className="bg-zinc-900 text-white">
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Type</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Typical Application</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider">Key Advantage</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-200">
                                        {[
                                            { type: "CNC Machined Aluminium", app: "RF modules, high-precision chassis, defence sub-systems", adv: "Tight tolerances, complex geometry, excellent EMI shielding" },
                                            { type: "Sheet Metal (SPCC, SS, Al)", app: "Industrial electronics, rack-mount chassis, control panels", adv: "Cost-effective for mid-volume, good structural-to-weight ratio" },
                                            { type: "Aluminium Extrusion", app: "Heat-dissipating enclosures, DIN rail housings", adv: "Integral heat sink geometry, excellent thermal path, low per-unit cost" }
                                        ].map((row, idx) => (
                                            <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                                                <td className="px-6 py-4 font-semibold text-zinc-900 border-r border-zinc-200">{row.type}</td>
                                                <td className="px-6 py-4 text-zinc-600 border-r border-zinc-200">{row.app}</td>
                                                <td className="px-6 py-4 text-zinc-600 italic">{row.adv}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="p-5 rounded-xl border border-zinc-200 bg-white">
                                    <h4 className="text-sm font-bold text-zinc-900 uppercase tracking-widest mb-3">Materials</h4>
                                    <p className="text-sm text-zinc-600 leading-6">Aluminium Alloy 6061-T6, 5052; Stainless Steel 304 / 316; SPCC mild steel</p>
                                </div>
                                <div className="p-5 rounded-xl border border-zinc-200 bg-white">
                                    <h4 className="text-sm font-bold text-zinc-900 uppercase tracking-widest mb-3">Core Treatments</h4>
                                    <p className="text-sm text-zinc-600 leading-6">Anodising Type II / Type III; Chromate conversion; Powder coating</p>
                                </div>
                                <div className="p-5 rounded-xl border border-zinc-200 bg-white">
                                    <h4 className="text-sm font-bold text-zinc-900 uppercase tracking-widest mb-3">Precision Plating</h4>
                                    <p className="text-sm text-zinc-600 leading-6">Gold plating; Electroless nickel; Hard chrome for wear-critical interfaces</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-2/3 space-y-12">
                            <div className="">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={idx} className="flex items-center gap-4 p-4 rounded-xl border border-zinc-200 bg-white shadow-sm group hover:border-zinc-900 transition-all">
                                            ...
                                            <span className="text-sm font-medium text-zinc-900 leading-snug">{approach}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-[0_8px_32px_rgba(24,24,27,0.04)] relative overflow-hidden">
                                <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
                                    <svg className="h-32 w-32" fill="currentColor" viewBox="0 0 24 24"><path d="M12,2L4.5,20.29L5.21,21L12,18L18.79,21L19.5,20.29L12,2Z" /></svg>
                                </div>
                                <div className="relative">
                                    <h3 className="text-lg font-semibold text-zinc-900 mb-4 pb-2 border-b border-zinc-100 flex items-center justify-between">
                                        ...
                                        <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest bg-zinc-50 px-3 py-1 rounded-full border border-zinc-200">Manpack Comms</span>
                                    </h3>
                                    <h4 className="text-sm font-bold text-zinc-800 mb-3">Manpack Communication Equipment</h4>
                        ...
                        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm border-collapse">
                                    <thead>
                                        <tr className="bg-zinc-900 text-white">
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">IP Rating</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800 text-center">Solid / Liquid Protection</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider">Typical Application</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-200">
                                        {[
                                            { rating: "IP65", solid: "Dust-tight", liquid: "Water jets from any direction", app: "Outdoor industrial, field instruments" },
                                            { rating: "IP67", solid: "Dust-tight", liquid: "Immersion 1 m / 30 min", app: "Handheld devices, marine equipment" },
                                            { rating: "IP68", solid: "Dust-tight", liquid: "Continuous immersion (specified depth)", app: "Subsea, underwater sensors" }
                                        ].map((row, idx) => (
                                            <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                                                <td className="px-6 py-4 font-semibold text-zinc-900 border-r border-zinc-200">{row.rating}</td>
                                                <td className="px-6 py-4 text-zinc-600 border-r border-zinc-200">
                                                    <div className="flex flex-col items-center">
                                                        <span className="font-bold">{row.solid}</span>
                                                        <span className="text-xs text-zinc-400">{row.liquid}</span>
                                                    </div>
                                                </td>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-6 rounded-2xl border border-zinc-200 bg-white shadow-sm">
                                <h3 className="text-lg font-semibold text-zinc-900 mb-4 pb-2 border-b border-zinc-100 flex items-center gap-2">
                                    <svg className="h-5 w-5 text-zinc-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4Z" /></svg>
                            ...
                            <div className="p-6 rounded-2xl border border-zinc-200 bg-zinc-900 text-white shadow-lg overflow-hidden relative group">
                                ...
                                <h3 className="text-lg font-semibold mb-4 pb-2 border-b border-zinc-800 flex items-center justify-between relative">
                                    Portfolio
                                    <span className="text-[10px] font-bold text-blue-400 uppercase tracking-widest bg-blue-400/10 px-2 py-0.5 rounded border border-blue-400/20">Satellite Comms</span>
                                </h3>
                                <h4 className="text-sm font-bold text-zinc-100 mb-3 relative">Satellite Antenna Stabiliser</h4>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="lg:w-2/3 space-y-12">
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {[
                                        { title: "Mechanism Design & Kinematics", desc: "Linkage geometry, cam and follower, pivot and hinge design, travel limits, actuation force analysis" },
                                        { title: "Electromechanical Integration", desc: "Motor and actuator mounting, encoder alignment, harness routing within mechanical sub-systems" },
                                        { title: "Optical and Sensor Systems", desc: "Mechanical design of optical assemblies and precision mounting structures" },
                                        { title: "Cable Management", desc: "EMI-segregated routing, strain relief design, bend radius compliance" }
                                    ].map((cap, idx) => (
                                        <div key={idx} className="group p-5 rounded-xl border border-zinc-200 bg-white shadow-sm hover:border-zinc-900 transition-all">
                                            <h4 className="text-sm font-bold text-zinc-900 mb-2 uppercase tracking-wide group-hover:text-zinc-600 transition-colors">{cap.title}</h4>
                                            <p className="text-sm text-zinc-600 leading-6">{cap.desc}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-[0_8px_32px_rgba(24,24,27,0.04)] relative overflow-hidden">
                                <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
                                    <svg className="h-32 w-32" fill="currentColor" viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M11,16.5L16.5,11L15.08,9.58L11,13.67L8.92,11.59L7.5,13L11,16.5Z" /></svg>
                                </div>
                                <div className="relative">
                                    <h3 className="text-lg font-semibold text-zinc-900 mb-4 pb-2 border-b border-zinc-100 flex items-center justify-between">
                                        Portfolio Case Study
                                        <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest bg-zinc-50 px-3 py-1 rounded-full border border-zinc-200">Medical Systems</span>
                                    </h3>
                                    <h4 className="text-sm font-bold text-zinc-800 mb-3">Foot Switch for Ophthalmic Surgery (Cataract)</h4>
                                    <p className="text-sm leading-7 text-zinc-600">
                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm border-collapse">
                                    <thead>
                                        <tr className="bg-zinc-900 text-white">
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">DFx Discipline</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider">What We Address</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-200">
                                        {[
                                            { discipline: "DFM — Manufacturability", address: "Tolerances set to process capability. Features designed to the manufacturing method. Tooling complexity minimised." },
                                            { discipline: "DFC — Cost", address: "Material selection, process route, finish specification, and fastener standardisation evaluated for BOM cost." },
                                            { discipline: "DFA — Assembly", address: "Part count minimisation, self-locating features, fastener access, tooling access, and assembly sequence reviewed." },
                                            { discipline: "DFC — Compliance", address: "RoHS, REACH, CE marking, MIL, JSS, IEC, ISO addressed at design stage, not at submission." }
                                        ].map((row, idx) => (
                                            <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                                                <td className="px-6 py-4 font-semibold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">{row.discipline}</td>
                                                <td className="px-6 py-4 text-zinc-600 leading-relaxed">{row.address}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                        ...
                        <div className="p-8 rounded-[2rem] border border-zinc-200 bg-zinc-50 shadow-inner relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-8 opacity-5">
                                <svg className="h-40 w-40" fill="currentColor" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20M11.2,18.46L15.07,14.59L13.66,13.18L11.2,15.64L9.78,14.22L8.37,15.63L11.2,18.46Z" /></svg>
                            </div>
                            <div className="relative">
                                ...
                                <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {["ISO 286", "ASME Y14.5", "GD&T", "RoHS/REACH"].map((std) => (
                                        <div key={std} className="px-4 py-2 rounded-lg bg-white border border-zinc-200 text-center text-[10px] font-bold text-zinc-400 uppercase tracking-widest shadow-sm">
                                            {std}
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-3 p-3 rounded-lg border border-zinc-200 bg-white shadow-sm">
                                ...
                                <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-left text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-zinc-900 text-white">
                                                    <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Analysis Type</th>
                                                    <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Standard / Method</th>
                                                    <th className="px-6 py-4 font-semibold uppercase tracking-wider">Expected Output</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-zinc-200">
                                                {[
                                                    { type: "Static Stress", meth: "FEA (linear / non-linear)", out: "Safety factors, stress concentrations, deflection maps" },
                                                    { type: "Modal Analysis", meth: "FEA eigenvalue extraction", out: "Natural frequencies, mode shapes, resonance risk" },
                                                    { type: "Vibration (Sinusoidal)", meth: "MIL-STD-810 / DO-160", out: "Stress response, fatigue life estimate" },
                                                    { type: "Vibration (Random)", meth: "MIL-STD-810 / JSS 55555", out: "RMS stress, component reliability prediction" },
                                                    { type: "Mechanical Shock", meth: "MIL-STD-810 Method 516.8", out: "Peak response, component survivability" },
                                                    { type: "Drop Test Analysis", meth: "IEC 60068-2-31", out: "Impact force, energy absorption, failure prediction" }
                                                ].map((row, idx) => (
                                                    <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                                                        <td className="px-6 py-4 font-semibold text-zinc-900 border-r border-zinc-200">{row.type}</td>
                                                        <td className="px-6 py-4 text-zinc-500 border-r border-zinc-200 italic">{row.meth}</td>
                                                        <td className="px-6 py-4 text-zinc-600 font-medium">{row.out}</td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                        </table>
            ...
            <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12">
                    <div className="lg:w-1/3">
                        <div className="inline-flex items-center gap-4 text-zinc-400 mb-6">
                            <span className="text-sm font-bold uppercase tracking-[0.2em]">Portfolio</span>
                            <div className="h-px w-12 bg-zinc-300"></div>
                        </div>
                        <h2 className="text-3xl font-semibold text-zinc-900 mb-4 uppercase tracking-tight">
                            Selected Portfolio
                        ...
                        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm border-collapse">
                                    <thead>
                                        <tr className="bg-zinc-900 text-white">
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Sector</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider border-r border-zinc-800">Product</th>
                                            <th className="px-6 py-4 font-semibold uppercase tracking-wider">Key Engineering Challenge</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-200">
                                        {[
                                            ...
                                            { sector: "Marine / Satcom", product: "Satellite Antenna Stabiliser", challenge: "Shipborne, IP-rated, 3-axis motion compensation in salt environment" },
                                            { sector: "Medical", product: "Ophthalmic Surgery Foot Switch", challenge: "Precision actuation, ergonomic, IP-rated, CE-marked medical device" },
                                            ...
                                            { sector: "Automotive", product: "Handheld OBD2 Diagnostic Device", challenge: "Workshop-grade, 4G/Wi-Fi/LCD/battery, drop-resistant, ergonomic grip" }
                                        ].map((row, idx) => (
                                            <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                                                <td className="px-6 py-4 font-semibold text-zinc-900 border-r border-zinc-200 whitespace-nowrap">{row.sector}</td>
                                                <td className="px-6 py-4 text-zinc-900 font-medium border-r border-zinc-200">{row.product}</td>
                                                <td className="px-6 py-4 text-zinc-600 leading-relaxed font-normal italic">{row.challenge}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                    ...
                    <div className="relative grid gap-12 px-6 py-12 md:px-12 md:py-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-semibold leading-[1.1] text-zinc-900 md:text-5xl">
                                1-Hour Complimentary <br/>Engineering Consultation
                            </h2>
                            <p className="max-w-2xl text-base leading-[1.75] text-zinc-600 font-medium md:text-lg">
                                ...
                                <span className="block mt-4 text-zinc-900 font-bold">No sales presentation. No obligations.</span>
                            </p>
                        ...
                        <div className="grid gap-4 relative">
                            ...
                            <div className="rounded-3xl border border-zinc-200 bg-zinc-950 p-8 text-white shadow-[0_32px_64px_rgba(24,24,27,0.2)]">
                                ...
                                <div className="space-y-6">
                                    {[
                                        { title: "Technical Feasibility", desc: "Evaluating materials and manufacturing routes." },
                                        { title: "Compliance Roadmap", desc: "Identifying required standards (MIL, IP, ISO)." },
                                        { title: "Cost Optimization", desc: "DFM/DFA strategies for your BOM." }
                                    ].map((item, idx) => (
                                        <div key={idx} className="flex gap-5 group">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs leading-5 text-zinc-400 font-medium">{item.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
